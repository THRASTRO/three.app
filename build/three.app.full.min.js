...
c.create=function(){var a="string"==typeof arguments[0]?[].shift.call(arguments):null,m=arguments[0]||c,h=arguments[1]||[],l=function(){this.pending=0;this.options=d.extend({},this.defaults);b.apply(this,arguments);e.apply(this,arguments)};a&&eval("Klass = "+l.toString().replace(/\(\)/,a+"()"));l.prototype.name=a;return f.call(c,l,m,h)};c.mixin=function(a){1>arguments.length&&(a=[]);return f.call(c,function(){throw Error("Can't instantiate mixins");},null,a)};c.virtual=function(a,b){0==arguments.length&&
...
(function(a,d){function c(a,b,c,d){c=c.shader||"";d=d?1:0;Array.isArray(c)&&(c=c.join("\n"));return a.splice(b,d,c)}function b(a,b){if(a&&a.length)for(var g=0;g<a.length;g++){for(var d=!1,e=a[g],l=0;l<b.length;l++)e.after&&e.after.test(b[l])?(c(b,l+1,e,!1),l+=2,d=!0):e.before&&e.before.test(b[l])?(c(b,l,e,!1),l+=2,d=!0):e.replace&&e.replace.test(b[l])&&(c(b,l,e,!0),l+=1,d=!0);if(!d)throw Error("Shader Chunk not found");}}var e=d.Class.virtual(a.ShaderMaterial).ctor(function(a,b,c){a=this._args={chunks:b||
{},uniforms:c||{},parameters:a||{}};a.chunks.vertex||(a.chunks.vertex=[]);a.chunks.fragment||(a.chunks.fragment=[]);a.parameters.defines||(a.parameters.defines={})}).init(function(){var c=this._args.chunks,d=this._args.uniforms;"string"==typeof this._shaderLib&&(this._shaderLib=a.ShaderLib[this._shaderLib]||console.error("Unknown THREE.ShaderLib: "+this._shaderLib));var g=this._shaderLib,e=g.vertexShader.split(/\n+/),p=g.fragmentShader.split(/\n+/);b(c.vertex,e);b(c.fragment,p);a.ShaderMaterial.call(this,
{uniforms:a.UniformsUtils.merge([d,g.uniforms]),vertexShader:e.join("\n"),fragmentShader:p.join("\n"),lights:!0});this.type="CustomMaterial"});d("CustomMaterial",e)})(THREE,THREEAPP);
...
(function(a,d){var c=d.Class.create("LOD",d.Object3D,["Plugin"]).proto("provides","lod").proto("requires","camera").proto("requires","ui").ctor(function(a){a.lods=[]}).ready(function(b){b.listen("update-ui",function(){var c=new a.Matrix4;c.multiplyMatrices(b.camera.projectionMatrix,b.camera.matrixWorldInverse);var d=new a.Frustum;d.setFromMatrix(c);for(var c=b.camera.getWorldPosition(),h="",g=document.getElementById("lodInfo"),m=0,p=b.lods.length;m<p;m++){var l=b.lods[m].getWorldPosition(),n=c.distanceToSquared(l);
b.lods[m].inFrustum=d.intersectsSphere({center:l,radius:b.lods[m].radius||100});h+=sprintf("%02d) %.5f",m,n);if(b.lods[m].inFrustum){var n=n*Math.pow(b.camera.fov,2),l=b.lods[m].options.lod,k=0,q=l.length;if(k<q&&!l[k])debugger;for(;k<q&&n<l[k].min;)++k;k==q&&(k=-1);b.lods[m].level!=k&&(b.lods[m].level=k,b.lods[m].trigger("lod"));h+=" - lvl "+k+"<br>"}else h+=" - hidden<br>"}g&&(g.innerHTML=h)})});d("Plugin.LOD",c)})(THREE,THREEAPP);
...
(function(a){function d(){var a=arguments[0],b=d.cache;b[a]&&b.hasOwnProperty(a)||(b[a]=d.parse(a));return d.format.call(null,b[a],arguments)}function c(a){return"number"===typeof a?"number":"string"===typeof a?"string":Object.prototype.toString.call(a).slice(8,-1).toLowerCase()}var b=/[^T]/,e=/[^v]/,f=/[diefg]/,h=/bcdiefguxXS/,g=/[j]/,m=/^[^\x25]+/,p=/^\x25{2}/,l=/^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-gijostTuvxXSDR])/,n=/^([a-z_][a-z_\d]*)/i,k=/^\.([a-z_][a-z_\d]*)/i,
q=/^\[(\d+)\]/,y=/^[\+\-]/;d.format=function(a,m){var p=1,l=a.length,n,k,q=[],t,w,D,r=!0,v;for(t=0;t<l;t++)if(n=c(a[t]),"string"===n)q[q.length]=a[t];else if("array"===n){n=a[t];if(n[2])for(k=m[p],w=0;w<n[2].length;w++){if(!k.hasOwnProperty(n[2][w]))throw Error(d('[sprintf] property "%s" does not exist',n[2][w]));k=k[n[2][w]]}else k=n[1]?m[n[1]]:m[p++];b.test(n[8])&&e.test(n[8])&&"function"==c(k)&&(k=k());if(h.test(n[8])&&"number"!=c(k)&&isNaN(k))throw new TypeError(d("[sprintf] expecting number but found %s",
c(k)));f.test(n[8])&&(r=0<=k);switch(n[8]){case "b":k=parseInt(k,10).toString(2);break;case "c":k=String.fromCharCode(parseInt(k,10));break;case "d":case "i":k=parseInt(k,10);break;case "j":k=JSON.stringify(k,null,n[6]?parseInt(n[6]):0);break;case "e":k=n[7]?parseFloat(k).toExponential(n[7]):parseFloat(k).toExponential();break;case "f":k=n[7]?parseFloat(k).toFixed(n[7]):parseFloat(k);break;case "g":k=n[7]?parseFloat(k).toPrecision(n[7]):parseFloat(k);break;case "o":k=k.toString(8);break;case "s":k=
String(k);k=n[7]?k.substring(0,n[7]):k;break;case "t":k=String(!!k);k=n[7]?k.substring(0,n[7]):k;break;case "S":if(1024>Math.abs(k))k+=" B";else{w="KiB MiB GiB TiB PiB EiB ZiB YiB".split(" ");v=-1;do k/=1024,++v;while(1024<=Math.abs(k)&&v<w.length-1);k=k.toFixed(1)+w[v]}break;case "R":v=k/Math.PI*180;k=v%1*60;w=k%1*60;k=d("%02d\u00b0 %02d' %0.2f\"",v,k,w);break;case "D":k+=Math.PI;v=k/Math.PI*12;k=v%1*60;w=k%1*60;k=d("%02dh %02dm %0.2fs",v,k,w);break;case "T":k=c(k);k=n[7]?k.substring(0,n[7]):k;break;
case "u":k=parseInt(k,10)>>>0;break;case "v":k=k.valueOf();k=n[7]?k.substring(0,n[7]):k;break;case "x":k=parseInt(k,10).toString(16);break;case "X":k=parseInt(k,10).toString(16).toUpperCase()}g.test(n[8])?q[q.length]=k:(!f.test(n[8])||r&&!n[3]?v="":(v=r?"+":"-",k=k.toString().replace(y,"")),w=n[4]?"0"===n[4]?"0":n[4].charAt(1):" ",D=n[6]-(v+k).length,D=n[6]?0<D?0<=D&&7>=D&&u[w]?u[w][D]:Array(D+1).join(w):"":"",q[q.length]=n[5]?v+k+D:"0"===w?v+D+k:D+v+k)}return q.join("")};d.cache={};d.parse=function(a){for(var b,
c=[],g=0;a;){if(null!==(b=m.exec(a)))c[c.length]=b[0];else if(null!==(b=p.exec(a)))c[c.length]="%";else if(null!==(b=l.exec(a))){if(b[2]){var g=g|1,d=[],e=b[2],h;if(null!==(h=n.exec(e)))for(d[d.length]=h[1];""!==(e=e.substring(h[0].length));)if(null!==(h=k.exec(e)))d[d.length]=h[1];else if(null!==(h=q.exec(e)))d[d.length]=h[1];else throw new SyntaxError("[sprintf] failed to parse named argument key");else throw new SyntaxError("[sprintf] failed to parse named argument key");b[2]=d}else g|=2;if(3===
...
(function(a,d,c){var b=requestAnimationFrame;a=c.Class.create("ThreeApp",null,["Events","Options"]).defaults({root:".",log:{debug:!1,info:!1,warn:!0}}).ctor(function(a,b){this.frames=9999;this.viewport=a;this.root=this.options.root.split(/\/+/);c.extend(this.options,b)}).init(function(a,b){a=this;b=this.options;for(var c=this.options.plugins||[],g=[].concat(c),d=0;d<g.length;){var p=g[d].prototype.required;if(p&&p.length)++d;else{p=g.splice(d,1)[0];if(p.prototype.provided){for(var l=p.prototype.provided,
n=0;n<g.length;n++)for(var k in l){var d=g[n].prototype.required,q=(d||[]).indexOf(k);-1!=q&&d.splice(q,1)}d=0}l=p.prototype.name;p=new p(this,b[l]);c[n]=c[l]=p;a.wait&&a.wait(c[n])}}if(g.length){for(n=0;n<g.length;n++)l=g[n].name,d=g[n].prototype.required,console.warn(l,"is missing",d);throw Error("Missing or circular dependencies");}a.plugins=c}).ready(function(){var a=this;this.options.start&&window.setTimeout(function(){a.start()},0)}).method("start",function(){var a=this;a.started||a.paused||
...
a.t_start=Date.now();b.invoke("calculate",a);this.invoke("calculate",b,a);a.postMessage(d,e);a.idle=!1}}function b(a){var b=this.task,d=this.parent,e=a.data[0],f=a.data[1],n=a.data[2],k=a.data[3],q=b.tbuffers;f&&!isNaN(f.length)&&(q.cmds=f);q.args=n;q.uniforms=k;f=q.input;k=q.backups;n=q.shareds;q.backups=q.results;q.results=k;f=f?f.length:0;n=n.length;for(k=0;k<f;k++)q.input[k]=a.data[5+k];for(k=0;k<n;k++)q.shareds[k]=a.data[5+f+k];for(var y=a.data.length-5-f-n,k=0;k<y;k++)q.results[k]=a.data[5+
f+n+k];--d.load;d.tasks+=e;d.batches+=1;this.task=b.worker=null;this.idle=!0;this.t_result=Date.now();this.t_busy+=this.t_result-this.t_start;0<d.queue.length&&(a=d.queue.shift(),a.queued=!1,c.call(d,this,a));d.invoke("calculated",b,this);b.invoke("calculated",this)}function e(a){if(a.data.run)this.onmessage=b;else throw Error("unexpected message");}var f=0;a=d.Class.create("Tasker",null,["Events","Options"]).ctor(function(){this.PLUGINS={};this.plugins=[];this.workers=[];this.queue=[];this.batches=
...
(function(a){function d(a){for(var b=0,c=a.length;c--;)128!=(a[c]&192)&&++b;return b}function c(){if(h>=f)throw Error("Invalid byte index");var a=e[h++]&255;if(128==(a&192))return a&63;throw Error("Invalid continuation byte");}function b(){var a,b,d,l;if((h|0)>(f|0))throw Error("Invalid byte index");a=e[h]&255;h=h+1|0;if(0==(a&128))return a;if(192==(a&224)){b=c();a=(a&31)<<6|b;if(128<=a)return a;throw Error("Invalid continuation byte");}if(224==(a&240)){b=c();d=c();a=(a&15)<<12|b<<6|d;if(2048<=a){if(55296<=
a&&57343>=a)throw Error("Lone surrogate U+"+a.toString(16).toUpperCase()+" is not a scalar value");return a}throw Error("Invalid continuation byte");}if(240==(a&248)&&(b=c(),d=c(),l=c(),a=(a&7)<<18|b<<12|d<<6|l,65536<=a&&1114111>=a))return a;throw Error("Invalid UTF-8 detected");}var e,f,h;a.count=d;a.decode=function(a){var c=0,p=d(a),p=new Uint16Array(p);h=0;e=a;f=a.length;for(2<(f|0)&239==(e[0]|0)&187==(e[1]|0)&191==(e[2]|0)&&(h=3);(h|0)<(f|0);)a=b()|0,p[c++]=a;return p};"undefined"!=typeof LZMA&&
...
b){Object.defineProperty(a,b,{get:function(){if("HSV"===this.__state.space)return this.__state[b];l.recalculateHSV(this);return this.__state[b]},set:function(a){"HSV"!==this.__state.space&&(l.recalculateHSV(this),this.__state.space="HSV");this.__state[b]=a}})}d.__esModule=!0;a=c(3);var h=b(a);a=c(6);var g=b(a);a=c(4);var m=b(a);c=c(5);var p=b(c),l=function(){function a(){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");this.__state=h.default.apply(this,arguments);if(!1===
this.__state)throw Error("Failed to interpret color arguments");this.__state.a=this.__state.a||1}a.prototype.toString=function(){return(0,m.default)(this)};a.prototype.toHexString=function(){return(0,m.default)(this,!0)};a.prototype.toOriginal=function(){return this.__state.conversion.write(this)};return a}();l.recalculateRGB=function(a,b,c){if("HEX"===a.__state.space)a.__state[b]=g.default.component_from_hex(a.__state.hex,c);else if("HSV"===a.__state.space)p.default.extend(a.__state,g.default.hsv_to_rgb(a.__state.h,
...
l=a.s.toFixed(1),n=a.v.toFixed(1);if(b||"THREE_CHAR_HEX"===d||"SIX_CHAR_HEX"===d){for(a=a.hex.toString(16);6>a.length;)a="0"+a;return"#"+a}return"CSS_RGB"===d?"rgb("+f+","+h+","+g+")":"CSS_RGBA"===d?"rgba("+f+","+h+","+g+","+m+")":"HEX"===d?"0x"+a.hex.toString(16):"RGB_ARRAY"===d?"["+f+","+h+","+g+"]":"RGBA_ARRAY"===d?"["+f+","+h+","+g+","+m+"]":"RGB_OBJ"===d?"{r:"+f+",g:"+h+",b:"+g+"}":"RGBA_OBJ"===d?"{r:"+f+",g:"+h+",b:"+g+",a:"+m+"}":"HSV_OBJ"===d?"{h:"+p+",s:"+l+",v:"+n+"}":"HSVA_OBJ"===d?"{h:"+
p+",s:"+l+",v:"+n+",a:"+m+"}":"unknown format"}},function(a,d){d.__esModule=!0;var c=Array.prototype.forEach,b=Array.prototype.slice;a={BREAK:{},extend:function(a){this.each(b.call(arguments,1),function(b){(this.isObject(b)?Object.keys(b):[]).forEach(function(c){this.isUndefined(b[c])||(a[c]=b[c])}.bind(this))},this);return a},defaults:function(a){this.each(b.call(arguments,1),function(b){(this.isObject(b)?Object.keys(b):[]).forEach(function(c){this.isUndefined(a[c])&&(a[c]=b[c])}.bind(this))},this);
...
"background: -o-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);";a.style.cssText+="background: -ms-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);";a.style.cssText+="background: linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);"}d.__esModule=!0;a=c(7);a=b(a);var m=c(9),p=b(m),m=c(2),l=b(m),m=c(3),n=b(m);c=c(5);var k=b(c);
c=function(a){function b(c,d){function f(a){F(a);p.default.bind(document,"mousemove",F);p.default.bind(document,"mouseup",m)}function m(){p.default.unbind(document,"mousemove",F);p.default.unbind(document,"mouseup",m);E()}function q(){var a=(0,n.default)(this.value);!1!==a?(w.__color.__state=a,w.setValue(w.__color.toOriginal())):this.value=w.__color.toString()}function A(){p.default.unbind(document,"mousemove",C);p.default.unbind(document,"mouseup",A);E()}function E(){w.__onFinishChange&&w.__onFinishChange.call(w,
...
c.__selector.appendChild(c.__hue_field);c.__hue_field.appendChild(c.__hue_knob);c.domElement.appendChild(c.__input);c.domElement.appendChild(c.__selector);c.updateDisplay();return c}f(b,a);b.prototype.updateDisplay=function(){var a=(0,n.default)(this.getValue());if(!1!==a){var b=!1;k.default.each(l.default.COMPONENTS,function(c){if(!k.default.isUndefined(a[c])&&!k.default.isUndefined(this.__color.__state[c])&&a[c]!==this.__color.__state[c])return b=!0,{}},this);b&&k.default.extend(this.__color.__state,
...
f.appendChild(b.domElement);d=e(a,f,d.before);r.default.addClass(d,B.CLASS_CONTROLLER_ROW);b instanceof C.default?r.default.addClass(d,"color"):r.default.addClass(d,t(b.getValue()));h(a,d,b);a.__controllers.push(b);return b}function p(a,b,c){var d=document.createElement("option");d.innerHTML=b;d.value=b;a.__preset_select.appendChild(d);c&&(a.__preset_select.selectedIndex=a.__preset_select.length-1)}function l(a){var b=a.__save_row=document.createElement("li");r.default.addClass(a.domElement,"has-save");
...
TWEEN.Tween=function(a){var d={},c={},b={},e=1E3,f=0,h,g=!1,m=!1,p=0,l=null,n=TWEEN.Easing.Linear.None,k=TWEEN.Interpolation.Linear,q=[],y=null,t=!1,u=null,z=null,x=null;this.to=function(a,b){c=a;void 0!==b&&(e=b);return this};this.start=function(e){TWEEN.add(this);m=!0;t=!1;l=void 0!==e?e:TWEEN.now();l+=p;for(var f in c){if(c[f]instanceof Array){if(0===c[f].length)continue;c[f]=[a[f]].concat(c[f])}void 0!==a[f]&&(d[f]=a[f],!1===d[f]instanceof Array&&(d[f]*=1),b[f]=d[f]||0)}return this};this.stop=
function(){if(!m)return this;TWEEN.remove(this);m=!1;null!==x&&x.call(a,a);this.stopChainedTweens();return this};this.end=function(){this.update(l+e);return this};this.stopChainedTweens=function(){for(var a=0,b=q.length;a<b;a++)q[a].stop()};this.delay=function(a){p=a;return this};this.repeat=function(a){f=a;return this};this.repeatDelay=function(a){h=a;return this};this.yoyo=function(a){g=a;return this};this.easing=function(a){n=a;return this};this.interpolation=function(a){k=a;return this};this.chain=
function(){q=arguments;return this};this.onStart=function(a){y=a;return this};this.onUpdate=function(a){u=a;return this};this.onComplete=function(a){z=a;return this};this.onStop=function(a){x=a;return this};this.update=function(m){var x,A,E;if(m<l)return!0;!1===t&&(null!==y&&y.call(a,a),t=!0);A=(m-l)/e;A=1<A?1:A;E=n(A);for(x in c)if(void 0!==d[x]){var F=d[x]||0,C=c[x];C instanceof Array?a[x]=k(C,E):("string"===typeof C&&(C="+"===C.charAt(0)||"-"===C.charAt(0)?F+parseFloat(C):parseFloat(C)),"number"===
typeof C&&(a[x]=F+(C-F)*E))}null!==u&&u.call(a,E);if(1===A)if(0<f){isFinite(f)&&f--;for(x in b)"string"===typeof c[x]&&(b[x]+=parseFloat(c[x])),g&&(A=b[x],b[x]=c[x],c[x]=A),d[x]=b[x];l=void 0!==h?m+h:m+p}else{null!==z&&z.call(a,a);m=0;for(x=q.length;m<x;m++)q[m].start(l+e);return!1}return!0}};
