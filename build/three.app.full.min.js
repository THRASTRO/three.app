...
$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};if(!$jscomp.global.Symbol){$jscomp.global.Symbol=$jscomp.Symbol;var a=[],d=function(c){return function(b){a=[];b=c(b);for(var e=[],d=0,h=b.length;d<h;d++){var g;a:if(g=b[d],g.length<$jscomp.SYMBOL_PREFIX.length)g=!1;else{for(var l=0;l<$jscomp.SYMBOL_PREFIX.length;l++)if(g[l]!=$jscomp.SYMBOL_PREFIX[l]){g=!1;break a}g=!0}g?a.push(b[d]):e.push(b[d])}return e}};$jscomp.patch("Object.keys",d);$jscomp.patch("Object.getOwnPropertyNames",d);$jscomp.patch("Object.getOwnPropertySymbols",
...
(function(a,d){function c(a,b){for(var g=a.split(/\./),l=c,e=0;e<g.length-1;e++)l[g[e]]||(l[g[e]]={}),l=l[g[e]];if(1==arguments.length)return l[g[e]];var d=typeof l[g[e]];if("object"==d){var d=l[g[e]],m;for(m in d)d.hasOwnProperty(m)&&(b[m]=d[m])}else if("undefined"!=d)throw Error("Namespace already taken!");return l[g[e]]=b}function b(){var a,c=!1,g=0,l=arguments.length;"[object Boolean]"===Object.prototype.toString.call(arguments[0])&&(c=arguments[0],g++);for(a=arguments[g++];g<l;g++){var e=arguments[g],
...
function(b){a.prototype.ready.push(b);return this};a.listen=function(b,c,l){var e=a.prototype.listeners;e[b]||(e[b]=[]);null!=l&&(c.prio=l);e[b].push(c);"ready"==b&&this.isReady&&c.call(this);return this};return a}function h(a){function b(){--d.pending;e.apply(d)}function c(a){throw a;}var d=this;d.pending++;if(!a)throw Error("Invalid wait call");if("function"==typeof a.listen)a.listen("ready",b);else if("function"==typeof a.then)a.then(b,c);else throw Error("Invalid wait promise");return e.apply(d)}
c.create=function(){var a="string"==typeof arguments[0]?[].shift.call(arguments):null,l=arguments[0]||c,h=arguments[1]||[],n=function(){this.pending=0;this.options=d.extend({},this.defaults);b.apply(this,arguments);e.apply(this,arguments)};a&&eval("Klass = "+n.toString().replace(/\(\)/,a+"()"));n.prototype.name=a;return f.call(c,n,l,h)};c.mixin=function(a){1>arguments.length&&(a=[]);return f.call(c,function(){throw Error("Can't instantiate mixins");},null,a)};c.virtual=function(a,b){0==arguments.length&&
...
(function(a,d){function c(a){for(var b in a)this.resources[b]=a[b]}function b(a,b){return this.assets[a]?this.assets[a][2].data:b}var e={},f=d.Class.mixin(["Options","Events"]).ctor(function(a,b){this.assets={};this.prefetch=c;a.resources=e;this.resources=jQuery.extend({},this.resources,this.options.resources);a.listen("loader.complete",function(a,b){for(var g=a.cbs.length,c=0;c<g;c++)a.cbs[c].assets[2]=a,a.cbs[c].resolve&&a.cbs[c].resolve(),a.complete=!0,a.data=b})}).init(function(b){var c=this,
l=b.manager,d=c.resources,e;for(e in d){var f=d[e][0],k=d[e][1];this.assets[e]=d[e];if(b.resources[k]){var q={obj:this,assets:d[e]};b.resources[k].complete?d[e][2]=b.resources[k]:this.wait(new Promise(function(a,c){q.reject=c;q.resolve=a;b.resources[k].cbs.push(q)}))}else{var f=f.substr(0,1).toUpperCase(),y;if("S"==f)y=new a.TextLoader(l);else if("T"==f)y=new a.TextureLoader(l);else if("I"==f)y=new a.ImageLoader(l);else if("J"==f)y=new a.JsonLoader(l);else if("A"==f)y=new a.ArrayLoader(l);else if("B"==
f)y=new a.BlobLoader(l);else if("R"==f)y=new a.BinaryLoader(l);else if("O"==f)y=new a.ObjectLoader(l);else if("L"==f)y=new a.OBJLoader(l);else throw"Unknown loader type for resource";q={obj:this,assets:d[e]};this.wait(new Promise(function(a,d){q.reject=d;q.resolve=a;b.resources[k]={total:0,loaded:0,cbs:[q]};(function(a,l,e){y.load(l,function(a){b.invoke("loader.complete",e,a)},function(a){b.invoke("loader.progress",c,e,a)},d)})(f,k,b.resources[k])}))}}}).ready(function(){this.asset=b}).listen("ready",
...
(function(a,d){var c=d.Class.create("LOD",d.Object3D,["Plugin"]).proto("provides","lod").proto("requires","camera").proto("requires","ui").ctor(function(a){a.lods=[]}).ready(function(b){b.listen("update-ui",function(){var c=new a.Matrix4;c.multiplyMatrices(b.camera.projectionMatrix,b.camera.matrixWorldInverse);var d=new a.Frustum;d.setFromMatrix(c);for(var c=b.camera.getWorldPosition(),h="",g=document.getElementById("lodInfo"),l=0,p=b.lods.length;l<p;l++){var n=b.lods[l].getWorldPosition(),m=c.distanceToSquared(n);
b.lods[l].inFrustum=d.intersectsSphere({center:n,radius:b.lods[l].radius||100});h+=sprintf("%02d) %.5f",l,m);if(b.lods[l].inFrustum){var m=m*Math.pow(b.camera.fov,2),n=b.lods[l].options.lod,k=0,q=n.length;if(k<q&&!n[k])debugger;for(;k<q&&m<n[k].min;)++k;k==q&&(k=-1);b.lods[l].level!=k&&(b.lods[l].level=k,b.lods[l].trigger("lod"));h+=" - lvl "+k+"<br>"}else h+=" - hidden<br>"}g&&(g.innerHTML=h)})});d("Plugin.LOD",c)})(THREE,THREEAPP);
...
g));return d}function c(a){for(var b=p.children,c=0;c<b.length;c++)b[c].style.display=c===a?"block":"none";l=a}function b(a,b){a.appendChild(a.firstChild).style.height=Math.min(30,30-30*b)+"px"}var e=self.performance&&self.performance.now?self.performance.now.bind(performance):Date.now,f=e(),h=f,g=0,l=0,p=a("div","statsGPU","width:100px;opacity:0.9;cursor:pointer");p.addEventListener("mousedown",function(a){a.preventDefault();c(++l%p.children.length)},!1);var n=0,m=Infinity,k=0,q=d("fps","#0ff","#002"),
y=q.children[0],t=q.children[1];p.appendChild(q);var u=0,z=Infinity,x=0,q=d("ms","#0f0","#020"),M=q.children[0],N=q.children[1];p.appendChild(q);if(self.performance&&self.performance.memory){var A=0,E=Infinity,F=0,q=d("mb","#f08","#201"),C=q.children[0],w=q.children[1];p.appendChild(q)}c(l);return{REVISION:14,domElement:p,setMode:c,begin:function(){f=e()},end:function(){var a=e();u=a-f;z=Math.min(z,u);x=Math.max(x,u);M.textContent=(u|0)+" MS ("+(z|0)+"-"+(x|0)+")";b(N,u/200);g++;if(a>h+1E3&&(n=Math.round(1E3*
g/(a-h)),m=Math.min(m,n),k=Math.max(k,n),y.textContent=n+" FPS ("+m+"-"+k+")",b(t,n/100),h=a,g=0,void 0!==A)){var c=performance.memory.usedJSHeapSize,d=performance.memory.jsHeapSizeLimit;A=Math.round(9.54E-7*c);E=Math.min(E,A);F=Math.max(F,A);C.textContent=A+" MB ("+E+"-"+F+")";b(w,c/d)}return a},update:function(){f=this.end()}}};"object"===typeof module&&(module.exports=StatsGPU);
...
(function(a){function d(){var a=arguments[0],b=d.cache;b[a]&&b.hasOwnProperty(a)||(b[a]=d.parse(a));return d.format.call(null,b[a],arguments)}function c(a){return"number"===typeof a?"number":"string"===typeof a?"string":Object.prototype.toString.call(a).slice(8,-1).toLowerCase()}var b=/[^T]/,e=/[^v]/,f=/[diefg]/,h=/bcdiefguxXS/,g=/[j]/,l=/^[^\x25]+/,p=/^\x25{2}/,n=/^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-gijostTuvxXSDR])/,m=/^([a-z_][a-z_\d]*)/i,k=/^\.([a-z_][a-z_\d]*)/i,
q=/^\[(\d+)\]/,y=/^[\+\-]/;d.format=function(a,l){var p=1,n=a.length,m,k,q=[],t,w,D,r=!0,v;for(t=0;t<n;t++)if(m=c(a[t]),"string"===m)q[q.length]=a[t];else if("array"===m){m=a[t];if(m[2])for(k=l[p],w=0;w<m[2].length;w++){if(!k.hasOwnProperty(m[2][w]))throw Error(d('[sprintf] property "%s" does not exist',m[2][w]));k=k[m[2][w]]}else k=m[1]?l[m[1]]:l[p++];b.test(m[8])&&e.test(m[8])&&"function"==c(k)&&(k=k());if(h.test(m[8])&&"number"!=c(k)&&isNaN(k))throw new TypeError(d("[sprintf] expecting number but found %s",
c(k)));f.test(m[8])&&(r=0<=k);switch(m[8]){case "b":k=parseInt(k,10).toString(2);break;case "c":k=String.fromCharCode(parseInt(k,10));break;case "d":case "i":k=parseInt(k,10);break;case "j":k=JSON.stringify(k,null,m[6]?parseInt(m[6]):0);break;case "e":k=m[7]?parseFloat(k).toExponential(m[7]):parseFloat(k).toExponential();break;case "f":k=m[7]?parseFloat(k).toFixed(m[7]):parseFloat(k);break;case "g":k=m[7]?parseFloat(k).toPrecision(m[7]):parseFloat(k);break;case "o":k=k.toString(8);break;case "s":k=
String(k);k=m[7]?k.substring(0,m[7]):k;break;case "t":k=String(!!k);k=m[7]?k.substring(0,m[7]):k;break;case "S":if(1024>Math.abs(k))k+=" B";else{w="KiB MiB GiB TiB PiB EiB ZiB YiB".split(" ");v=-1;do k/=1024,++v;while(1024<=Math.abs(k)&&v<w.length-1);k=k.toFixed(1)+w[v]}break;case "R":v=k/Math.PI*180;k=v%1*60;w=k%1*60;k=d("%02d\u00b0 %02d' %0.2f\"",v,k,w);break;case "D":k+=Math.PI;v=k/Math.PI*12;k=v%1*60;w=k%1*60;k=d("%02dh %02dm %0.2fs",v,k,w);break;case "T":k=c(k);k=m[7]?k.substring(0,m[7]):k;break;
case "u":k=parseInt(k,10)>>>0;break;case "v":k=k.valueOf();k=m[7]?k.substring(0,m[7]):k;break;case "x":k=parseInt(k,10).toString(16);break;case "X":k=parseInt(k,10).toString(16).toUpperCase()}g.test(m[8])?q[q.length]=k:(!f.test(m[8])||r&&!m[3]?v="":(v=r?"+":"-",k=k.toString().replace(y,"")),w=m[4]?"0"===m[4]?"0":m[4].charAt(1):" ",D=m[6]-(v+k).length,D=m[6]?0<D?0<=D&&7>=D&&u[w]?u[w][D]:Array(D+1).join(w):"":"",q[q.length]=m[5]?v+k+D:"0"===w?v+D+k:D+v+k)}return q.join("")};d.cache={};d.parse=function(a){for(var b,
c=[],g=0;a;){if(null!==(b=l.exec(a)))c[c.length]=b[0];else if(null!==(b=p.exec(a)))c[c.length]="%";else if(null!==(b=n.exec(a))){if(b[2]){var g=g|1,d=[],e=b[2],h;if(null!==(h=m.exec(e)))for(d[d.length]=h[1];""!==(e=e.substring(h[0].length));)if(null!==(h=k.exec(e)))d[d.length]=h[1];else if(null!==(h=q.exec(e)))d[d.length]=h[1];else throw new SyntaxError("[sprintf] failed to parse named argument key");else throw new SyntaxError("[sprintf] failed to parse named argument key");b[2]=d}else g|=2;if(3===
...
(function(a,d){function c(a){var b=this.context,c=this.options;b.font=(a.fontSize||c.fontSize)+"px "+(a.fontFamily||c.fontFamily);b.fillStyle=a.color||c.fillStyle;b.strokeStyle=a.stroke||c.strokeStyle;b.lineWidth=a.lineWidth||c.lineWidth}function b(a){var b=a.fit,c=this.context,d=this.options;if(a.background||d.background)c.fillStyle=a.background||d.background,c.fillRect(b.x,b.y,a.w,a.h);if(a.borderStyle||d.borderStyle)c.strokeStyle=a.borderStyle||d.borderStyle,c.lineWidth=a.borderWidth||d.borderWidth||
1,c.rect(b.x,b.y,a.w,a.h),c.stroke()}function e(a){var b=a.fit,c=b.x+2,b=b.y+a.h,b=b-2-Math.round(a.h/6),d=this.context,e=this.options;(a.stroke||e.strokeStyle)&&d.strokeText(a.txt,c,b);(a.color||e.fillStyle)&&d.fillText(a.txt,c,b)}function f(a){a--;a|=a>>1;a|=a>>2;a|=a>>4;a|=a>>8;a|=a>>16;a++;return a}var h=new GrowingPacker;a=d.Class.create("Labels",null,["Group"]).defaults({hardLimit:8192,fontSize:10,fontFamily:"Tahoma, sans",strokeStyle:"#0F0F0F",lineWidth:1}).ctor(function(a){this.canvas=document.createElement("canvas");
this.context=this.canvas.getContext("2d");a.viewport.appendChild(this.canvas);this.canvas.style.position="absolute";this.canvas.style.display="none";this.canvas.style.left="0px";this.canvas.style.top="0px";this.canvas.height=128;this.canvas.width=128}).listen("resized",function(){this.items.sort(function(a,b){return Math.max(b.w,b.h)-Math.max(a.w,a.h)});for(var a=0;a<this.length;a+=1)delete this.items[a].fit;h.fit(this.items);var a=h.root,d=this.canvas,p=this.context;d.width=f(a.w);d.height=f(a.h);
p.clearRect(0,0,d.width,d.height);for(a=0;a<this.length;a+=1)b.call(this,this.items[a]),c.call(this,this.items[a]),e.call(this,this.items[a]);this.invoke("texture.drawn")}).listen("inserted",function(a){var b=this.context,d=this.options;c.call(this,a);a.h=2+(a.fontSize||d.fontSize)+2;b=b.measureText(a.txt);a.w=2+b.width+2});d("Labels",a)})(THREE,THREEAPP);
...
a.t_start=Date.now();b.invoke("calculate",a);this.invoke("calculate",b,a);a.postMessage(d,e);a.idle=!1}}function b(a){var b=this.task,d=this.parent,e=a.data[0],f=a.data[1],m=a.data[2],k=a.data[3],q=b.tbuffers;f&&!isNaN(f.length)&&(q.cmds=f);q.args=m;q.uniforms=k;f=q.input;k=q.backups;m=q.shareds;q.backups=q.results;q.results=k;f=f?f.length:0;m=m.length;for(k=0;k<f;k++)q.input[k]=a.data[5+k];for(k=0;k<m;k++)q.shareds[k]=a.data[5+f+k];for(var y=a.data.length-5-f-m,k=0;k<y;k++)q.results[k]=a.data[5+
f+m+k];--d.load;d.tasks+=e;d.batches+=1;this.task=b.worker=null;this.idle=!0;this.t_result=Date.now();this.t_busy+=this.t_result-this.t_start;0<d.queue.length&&(a=d.queue.shift(),a.queued=!1,c.call(d,this,a));d.invoke("calculated",b,this);b.invoke("calculated",this)}function e(a){if(a.data.run)this.onmessage=b;else throw Error("unexpected message");}var f=0;a=d.Class.create("Tasker",null,["Events","Options"]).ctor(function(){this.PLUGINS={};this.plugins=[];this.workers=[];this.queue=[];this.batches=
...
30-30*b),.25)+"px"}function h(){for(var a=Date.now(),b=a-L,c=0;c<app.tasker.workers.length;c++)I[c]&&(y[c]=(app.tasker.workers[c].t_busy-I[c])/b),I[c]=app.tasker.workers[c].t_busy;L=a}function g(a){var b="";1E10<=a?(a/=1E9,b="G"):1E7<=a?(a/=1E6,b="M"):1E4<=a&&(a/=1E3,b="K");a=parseInt(a);return a+b}var l=self.performance&&self.performance.now?self.performance.now.bind(performance):Date.now,p=l(),n=p,m=0,k=0,q=0;setInterval(function(){k++},20);setInterval(function(){q=Math.abs(50-k);k=0},1E3);var y=
...
"#020",a.threads);J=G.children[0];K=G.children[1];t.appendChild(G);b(3);for(var d=0;d<a.threads;d+=1)a.workers[d].busy=0,a.workers[d].idling=0;setInterval(h,1E3)});b(m);return{REVISION:14,domElement:t,setMode:b,begin:function(){p=l()},end:function(){var b=l();if(b>n+250){u=Math.round(1E3*a.tasks/(b-n));z=Math.max(z,u);M.textContent=g(u)+" TSK ("+g(z)+")";f(N,u/z);A=Math.round(1E3*a.batches/(b-n));E=Math.max(E,A);F.textContent=g(A)+" BAT ("+g(E)+")";f(C,A/E);w=Math.round(1E3*a.queue.length/(b-n));
...
b){Object.defineProperty(a,b,{get:function(){if("HSV"===this.__state.space)return this.__state[b];n.recalculateHSV(this);return this.__state[b]},set:function(a){"HSV"!==this.__state.space&&(n.recalculateHSV(this),this.__state.space="HSV");this.__state[b]=a}})}d.__esModule=!0;a=c(3);var h=b(a);a=c(6);var g=b(a);a=c(4);var l=b(a);c=c(5);var p=b(c),n=function(){function a(){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");this.__state=h.default.apply(this,arguments);if(!1===
this.__state)throw Error("Failed to interpret color arguments");this.__state.a=this.__state.a||1}a.prototype.toString=function(){return(0,l.default)(this)};a.prototype.toHexString=function(){return(0,l.default)(this,!0)};a.prototype.toOriginal=function(){return this.__state.conversion.write(this)};return a}();n.recalculateRGB=function(a,b,c){if("HEX"===a.__state.space)a.__state[b]=g.default.component_from_hex(a.__state.hex,c);else if("HSV"===a.__state.space)p.default.extend(a.__state,g.default.hsv_to_rgb(a.__state.h,
...
f=void 0,h=void 0;d.default=function(){h=!1;var a=1<arguments.length?b.default.toArray(arguments):arguments[0];b.default.each(e,function(c){if(c.litmus(a))return b.default.each(c.conversions,function(c,d){f=c.read(a);if(!1===h&&!1!==f)return h=f,f.conversionName=d,f.conversion=c,b.default.BREAK}),b.default.BREAK});return h}},function(a,d){d.__esModule=!0;d.default=function(a,b){var d=a.__state.conversionName.toString(),f=Math.round(a.r),h=Math.round(a.g),g=Math.round(a.b),l=a.a,p=Math.round(a.h),
n=a.s.toFixed(1),m=a.v.toFixed(1);if(b||"THREE_CHAR_HEX"===d||"SIX_CHAR_HEX"===d){for(a=a.hex.toString(16);6>a.length;)a="0"+a;return"#"+a}return"CSS_RGB"===d?"rgb("+f+","+h+","+g+")":"CSS_RGBA"===d?"rgba("+f+","+h+","+g+","+l+")":"HEX"===d?"0x"+a.hex.toString(16):"RGB_ARRAY"===d?"["+f+","+h+","+g+"]":"RGBA_ARRAY"===d?"["+f+","+h+","+g+","+l+"]":"RGB_OBJ"===d?"{r:"+f+",g:"+h+",b:"+g+"}":"RGBA_OBJ"===d?"{r:"+f+",g:"+h+",b:"+g+",a:"+l+"}":"HSV_OBJ"===d?"{h:"+p+",s:"+n+",v:"+m+"}":"HSVA_OBJ"===d?"{h:"+
p+",s:"+n+",v:"+m+",a:"+l+"}":"unknown format"}},function(a,d){d.__esModule=!0;var c=Array.prototype.forEach,b=Array.prototype.slice;a={BREAK:{},extend:function(a){this.each(b.call(arguments,1),function(b){(this.isObject(b)?Object.keys(b):[]).forEach(function(c){this.isUndefined(b[c])||(a[c]=b[c])}.bind(this))},this);return a},defaults:function(a){this.each(b.call(arguments,1),function(b){(this.isObject(b)?Object.keys(b):[]).forEach(function(c){this.isUndefined(a[c])&&(a[c]=b[c])}.bind(this))},this);
return a},compose:function(){var a=b.call(arguments);return function(){for(var c=b.call(arguments),d=a.length-1;0<=d;d--)c=[a[d].apply(this,c)];return c[0]}},each:function(a,b,d){if(a)if(c&&a.forEach&&a.forEach===c)a.forEach(b,d);else if(a.length===a.length+0){var g,l;g=0;for(l=a.length;g<l&&!(g in a&&b.call(d,a[g],g)===this.BREAK);g++);}else for(g in a)if(b.call(d,a[g],g)===this.BREAK)break},defer:function(a){setTimeout(a,0)},debounce:function(a,b){var c=void 0;return function(){var d=arguments,
l=!c;clearTimeout(c);c=setTimeout(function(){c=null},b);l&&a.apply(this,d)}},toArray:function(a){return a.toArray?a.toArray():b.call(a)},isUndefined:function(a){return void 0===a},isNull:function(a){return null===a},isNaN:function(a){function b(c){return a.apply(this,arguments)}b.toString=function(){return a.toString()};return b}(function(a){return isNaN(a)}),isArray:Array.isArray||function(a){return a.constructor===Array},isObject:function(a){return a===Object(a)},isNumber:function(a){return a===
a+0},isString:function(a){return a===a+""},isBoolean:function(a){return!1===a||!0===a},isFunction:function(a){return"[object Function]"===Object.prototype.toString.call(a)}};d.default=a},function(a,d){d.__esModule=!0;var c=void 0;d.default={hsv_to_rgb:function(a,c,d){var h=a/60-Math.floor(a/60),g=d*(1-c),l=d*(1-h*c);c=d*(1-(1-h)*c);a=[[d,c,g],[l,d,g],[g,d,c],[g,l,d],[c,g,d],[d,g,l]][Math.floor(a/60)%6];return{r:255*a[0],g:255*a[1],b:255*a[2]}},rgb_to_hsv:function(a,c,d){var h=Math.max(a,c,d),g=h-
...
b){if("function"!==typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function, not "+typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}d.__esModule=!0;a=(a=c(7))&&a.__esModule?a:{default:a};var f=(c=c(9))&&c.__esModule?c:{default:c};c=function(a){function c(d,e){function n(){m.setValue(m.__input.value)}if(!(this instanceof c))throw new TypeError("Cannot call a class as a function");
...
"background: -o-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);";a.style.cssText+="background: -ms-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);";a.style.cssText+="background: linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);"}d.__esModule=!0;a=c(7);a=b(a);var l=c(9),p=b(l),l=c(2),n=b(l),l=c(3),m=b(l);c=c(5);var k=b(c);
c=function(a){function b(c,d){function f(a){F(a);p.default.bind(document,"mousemove",F);p.default.bind(document,"mouseup",l)}function l(){p.default.unbind(document,"mousemove",F);p.default.unbind(document,"mouseup",l);E()}function q(){var a=(0,m.default)(this.value);!1!==a?(w.__color.__state=a,w.setValue(w.__color.toOriginal())):this.value=w.__color.toString()}function A(){p.default.unbind(document,"mousemove",C);p.default.unbind(document,"mouseup",A);E()}function E(){w.__onFinishChange&&w.__onFinishChange.call(w,
...
c.__selector.appendChild(c.__hue_field);c.__hue_field.appendChild(c.__hue_knob);c.domElement.appendChild(c.__input);c.domElement.appendChild(c.__selector);c.updateDisplay();return c}f(b,a);b.prototype.updateDisplay=function(){var a=(0,m.default)(this.getValue());if(!1!==a){var b=!1;k.default.each(n.default.COMPONENTS,function(c){if(!k.default.isUndefined(a[c])&&!k.default.isUndefined(this.__color.__state[c])&&a[c]!==this.__color.__state[c])return b=!0,{}},this);b&&k.default.extend(this.__color.__state,
...
function f(a,b){a=a.__preset_select[a.__preset_select.selectedIndex];a.innerHTML=b?a.value+"*":a.value}function h(a,b,c){c.__li=b;c.__gui=a;v.default.extend(c,{options:function(b){if(1<arguments.length){var d=c.__li.nextElementSibling;c.remove();return l(a,c.object,c.property,{before:d,factoryArgs:[v.default.toArray(arguments)]})}if(v.default.isArray(b)||v.default.isObject(b))return d=c.__li.nextElementSibling,c.remove(),l(a,c.object,c.property,{before:d,factoryArgs:[b]})},name:function(a){c.__li.firstElementChild.firstElementChild.innerHTML=
...
else if(c instanceof E.default){var d=function(b){if(v.default.isNumber(c.__min)&&v.default.isNumber(c.__max)){b=c.__li.firstElementChild.firstElementChild.innerHTML;var d=-1<c.__gui.__listening.indexOf(c);c.remove();var e=l(a,c.object,c.property,{before:c.__li.nextElementSibling,factoryArgs:[c.__min,c.__max,c.__step]});e.name(b);d&&e.listen();return e}return b};c.min=v.default.compose(d,c.min);c.max=v.default.compose(d,c.max)}else c instanceof N.default?(r.default.bind(b,"click",function(){r.default.fakeEvent(c.__checkbox,
...
TWEEN.Tween=function(a){var d={},c={},b={},e=1E3,f=0,h,g=!1,l=!1,p=0,n=null,m=TWEEN.Easing.Linear.None,k=TWEEN.Interpolation.Linear,q=[],y=null,t=!1,u=null,z=null,x=null;this.to=function(a,b){c=a;void 0!==b&&(e=b);return this};this.start=function(e){TWEEN.add(this);l=!0;t=!1;n=void 0!==e?e:TWEEN.now();n+=p;for(var f in c){if(c[f]instanceof Array){if(0===c[f].length)continue;c[f]=[a[f]].concat(c[f])}void 0!==a[f]&&(d[f]=a[f],!1===d[f]instanceof Array&&(d[f]*=1),b[f]=d[f]||0)}return this};this.stop=
function(){if(!l)return this;TWEEN.remove(this);l=!1;null!==x&&x.call(a,a);this.stopChainedTweens();return this};this.end=function(){this.update(n+e);return this};this.stopChainedTweens=function(){for(var a=0,b=q.length;a<b;a++)q[a].stop()};this.delay=function(a){p=a;return this};this.repeat=function(a){f=a;return this};this.repeatDelay=function(a){h=a;return this};this.yoyo=function(a){g=a;return this};this.easing=function(a){m=a;return this};this.interpolation=function(a){k=a;return this};this.chain=
function(){q=arguments;return this};this.onStart=function(a){y=a;return this};this.onUpdate=function(a){u=a;return this};this.onComplete=function(a){z=a;return this};this.onStop=function(a){x=a;return this};this.update=function(l){var x,A,E;if(l<n)return!0;!1===t&&(null!==y&&y.call(a,a),t=!0);A=(l-n)/e;A=1<A?1:A;E=m(A);for(x in c)if(void 0!==d[x]){var F=d[x]||0,C=c[x];C instanceof Array?a[x]=k(C,E):("string"===typeof C&&(C="+"===C.charAt(0)||"-"===C.charAt(0)?F+parseFloat(C):parseFloat(C)),"number"===
typeof C&&(a[x]=F+(C-F)*E))}null!==u&&u.call(a,E);if(1===A)if(0<f){isFinite(f)&&f--;for(x in b)"string"===typeof c[x]&&(b[x]+=parseFloat(c[x])),g&&(A=b[x],b[x]=c[x],c[x]=A),d[x]=b[x];n=void 0!==h?l+h:l+p}else{null!==z&&z.call(a,a);l=0;for(x=q.length;l<x;l++)q[l].start(n+e);return!1}return!0}};
