...
$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};if(!$jscomp.global.Symbol){$jscomp.global.Symbol=$jscomp.Symbol;var a=[],d=function(c){return function(b){a=[];b=c(b);for(var e=[],d=0,k=b.length;d<k;d++){var g;a:if(g=b[d],g.length<$jscomp.SYMBOL_PREFIX.length)g=!1;else{for(var n=0;n<$jscomp.SYMBOL_PREFIX.length;n++)if(g[n]!=$jscomp.SYMBOL_PREFIX[n]){g=!1;break a}g=!0}g?a.push(b[d]):e.push(b[d])}return e}};$jscomp.patch("Object.keys",d);$jscomp.patch("Object.getOwnPropertyNames",d);$jscomp.patch("Object.getOwnPropertySymbols",
...
(function(a,d){function c(a,b){for(var g=a.split(/\./),n=c,e=0;e<g.length-1;e++)n[g[e]]||(n[g[e]]={}),n=n[g[e]];if(1==arguments.length)return n[g[e]];var d=typeof n[g[e]];if("object"==d){var d=n[g[e]],m;for(m in d)d.hasOwnProperty(m)&&(b[m]=d[m])}else if("undefined"!=d)throw Error("Namespace already taken!");return n[g[e]]=b}function b(){var a,c=!1,g=0,n=arguments.length;"[object Boolean]"===Object.prototype.toString.call(arguments[0])&&(c=arguments[0],g++);for(a=arguments[g++];g<n;g++){var e=arguments[g],
...
(function(a,d){function c(a,b){}function b(){for(var a={},b=this.ctor,c=0;c<b.length;c++)a[b[c]]||(b[c].apply(this,arguments),a[b[c]]=!0);b=this.init;this.__proto__.wait=k;for(c=0;c<b.length;c++)a[b[c]]||(b[c].apply(this,arguments),a[b[c]]=!0)}function e(){if(0<this.pending)return this;delete this.__proto__.wait;for(var a=0;a<this.ready.length;a++)this.ready[a].apply(this,arguments);if(this.listeners)for(var b=this.listeners.ready||[],a=0;a<b.length;a++)b[a].apply(this,arguments);delete this.pending;
this.isReady=!0;return this}function f(a,b,c){b||(b=d.Class);Array.isArray(c)||(c=[c]);if(!c)throw Error("Undefined mixin!");a.prototype.ctor||(a.prototype.ctor=[]);a.prototype.init||(a.prototype.init=[]);a.prototype.ready||(a.prototype.ready=[]);a.prototype.defaults||(a.prototype.defaults={});a.prototype.listeners||(a.prototype.listeners={});if(c&&c.length)for(var e=0,k=c.length;e<k;e++){if(!c[e])throw Error("Undefined mixin!");if(!(c[e]instanceof Function)){var f=d(c[e]);if("undefined"==typeof f)throw Error("Unknown mixin: "+
...
function(b){a.prototype.ready.push(b);return this};a.listen=function(b,c,n){var e=a.prototype.listeners;e[b]||(e[b]=[]);null!=n&&(c.prio=n);e[b].push(c);"ready"==b&&this.isReady&&c.call(this);return this};return a}function k(a){function b(){--d.pending;e.apply(d)}function c(a){throw a;}var d=this;d.pending++;if(!a)throw Error("Invalid wait call");if("function"==typeof a.listen)a.listen("ready",b);else if("function"==typeof a.then)a.then(b,c);else throw Error("Invalid wait promise");return e.apply(d)}
c.create=function(){var a="string"==typeof arguments[0]?[].shift.call(arguments):null,n=arguments[0]||c,k=arguments[1]||[],l=function(){this.pending=0;this.options=d.extend({},this.defaults);b.apply(this,arguments);e.apply(this,arguments)};a&&eval("Klass = "+l.toString().replace(/\(\)/,a+"()"));return f.call(c,l,n,k)};c.mixin=function(a){1>arguments.length&&(a=[]);return f.call(c,function(){throw Error("Can't instantiate mixins");},null,a)};c.virtual=function(a,b){0==arguments.length&&(a=c);if(!a)throw Error("Undefined virtual base!");
2>arguments.length&&(b=[]);return f.call(c,function(){throw Error("cannot instantiate virtual class");},a,b)};c.prototype.constructor=c;d("Class",c)})(THREE,THREEAPP);(function(a,d){a=d.Class.mixin().ctor(function(a,b){this.app=a;d.extend(this.options,b)});d("Options",a)})(THREE,THREEAPP);
...
k=0,g=d?d.length:0;k<g;k++)d[k].apply(this,c);this.deferred[a]=!1}).method("trigger",function(a){var c=this;if(!c.deferred[a]){var d=Array.prototype.slice.call(arguments,1);c.deferred[a]=window.setTimeout(function(){for(var k=c.listeners[a],g=0,n=k?k.length:0;g<n;g++)k[g].apply(c,d);c.deferred[a]=!1},0)}});d("Events",a)})(THREE,THREEAPP);
(function(a,d){a=d.Class.mixin(["Events"]).method("required",[]).method("provided",{}).method("requires",function(a){Array.isArray(a)?this.required=this.required.concat(a):this.required.push(a);return this}).method("provides",function(a){var b=this.provided;Array.isArray(a)||(a=[a]);for(var e=0,d=a.length;e<d;++e){if(b.hasOwnProperty(a[e]))throw Error("Duplicate service provider");b[a[e]]=!0}return this});d("Plugin",a)})(THREE,THREEAPP);
(function(a,d){function c(a){for(var b in a)this.resources[b]=a[b]}function b(a,b){return this.assets[a]?this.assets[a][2].data:b}var e={},f=d.Class.mixin(["Options","Events"]).ctor(function(a,b){this.assets={};this.prefetch=c;a.resources=e;this.resources=jQuery.extend({},this.resources,this.options.resources);a.listen("loader.complete",function(a,b){for(var c=a.cbs.length,g=0;g<c;g++)a.cbs[g].assets[2]=a,a.cbs[g].resolve&&a.cbs[g].resolve(),a.complete=!0,a.data=b})}).init(function(b){var c=this,
e=b.manager,d=c.resources,l;for(l in d){var f=d[l][0],h=d[l][1];this.assets[l]=d[l];if(b.resources[h]){var q={obj:this,assets:d[l]};b.resources[h].complete?d[l][2]=b.resources[h]:this.wait(new Promise(function(a,c){q.reject=c;q.resolve=a;b.resources[h].cbs.push(q)}))}else{var f=f.substr(0,1).toUpperCase(),y;if("S"==f)y=new a.TextLoader(e);else if("T"==f)y=new a.TextureLoader(e);else if("I"==f)y=new a.ImageLoader(e);else if("J"==f)y=new a.JsonLoader(e);else if("A"==f)y=new a.ArrayLoader(e);else if("B"==
f)y=new a.BlobLoader(e);else if("R"==f)y=new a.BinaryLoader(e);else if("O"==f)y=new a.ObjectLoader(e);else if("L"==f)y=new a.OBJLoader(e);else throw"Unknown loader type for resource";q={obj:this,assets:d[l]};this.wait(new Promise(function(a,e){q.reject=e;q.resolve=a;b.resources[h]={total:0,loaded:0,cbs:[q]};(function(a,d,n){y.load(d,function(a){b.invoke("loader.complete",n,a)},function(a){b.invoke("loader.progress",c,n,a)},e)})(f,h,b.resources[h])}))}}}).ready(function(){this.asset=b}).listen("ready",
...
(function(a,d){var c=d.Class.create("LOD",d.Object3D,["Plugin"]).proto("provides","lod").proto("requires","camera").proto("requires","ui").ctor(function(a){a.lods=[]}).ready(function(b){b.listen("update-ui",function(){var c=new a.Matrix4;c.multiplyMatrices(b.camera.projectionMatrix,b.camera.matrixWorldInverse);var d=new a.Frustum;d.setFromMatrix(c);for(var c=b.camera.getWorldPosition(),k="",g=document.getElementById("lodInfo"),n=0,p=b.lods.length;n<p;n++){var l=b.lods[n].getWorldPosition(),m=c.distanceToSquared(l);
b.lods[n].inFrustum=d.intersectsSphere({center:l,radius:b.lods[n].radius||100});k+=sprintf("%02d) %.5f",n,m);if(b.lods[n].inFrustum){var m=m*Math.pow(b.camera.fov,2),l=b.lods[n].options.lod,h=0,q=l.length;if(h<q&&!l[h])debugger;for(;h<q&&m<l[h].min;)++h;h==q&&(h=-1);b.lods[n].level!=h&&(b.lods[n].level=h,b.lods[n].trigger("lod"));k+=" - lvl "+h+"<br>"}else k+=" - hidden<br>"}g&&(g.innerHTML=k)})});d("Plugin.LOD",c)})(THREE,THREEAPP);
...
g));return d}function c(a){for(var b=p.children,c=0;c<b.length;c++)b[c].style.display=c===a?"block":"none";n=a}function b(a,b){a.appendChild(a.firstChild).style.height=Math.min(30,30-30*b)+"px"}var e=self.performance&&self.performance.now?self.performance.now.bind(performance):Date.now,f=e(),k=f,g=0,n=0,p=a("div","statsGPU","width:100px;opacity:0.9;cursor:pointer");p.addEventListener("mousedown",function(a){a.preventDefault();c(++n%p.children.length)},!1);var l=0,m=Infinity,h=0,q=d("fps","#0ff","#002"),
y=q.children[0],t=q.children[1];p.appendChild(q);var u=0,z=Infinity,x=0,q=d("ms","#0f0","#020"),M=q.children[0],N=q.children[1];p.appendChild(q);if(self.performance&&self.performance.memory){var A=0,E=Infinity,F=0,q=d("mb","#f08","#201"),C=q.children[0],w=q.children[1];p.appendChild(q)}c(n);return{REVISION:14,domElement:p,setMode:c,begin:function(){f=e()},end:function(){var a=e();u=a-f;z=Math.min(z,u);x=Math.max(x,u);M.textContent=(u|0)+" MS ("+(z|0)+"-"+(x|0)+")";b(N,u/200);g++;if(a>k+1E3&&(l=Math.round(1E3*
g/(a-k)),m=Math.min(m,l),h=Math.max(h,l),y.textContent=l+" FPS ("+m+"-"+h+")",b(t,l/100),k=a,g=0,void 0!==A)){var c=performance.memory.usedJSHeapSize,d=performance.memory.jsHeapSizeLimit;A=Math.round(9.54E-7*c);E=Math.min(E,A);F=Math.max(F,A);C.textContent=A+" MB ("+E+"-"+F+")";b(w,c/d)}return a},update:function(){f=this.end()}}};"object"===typeof module&&(module.exports=StatsGPU);
...
(function(a){function d(){var a=arguments[0],b=d.cache;b[a]&&b.hasOwnProperty(a)||(b[a]=d.parse(a));return d.format.call(null,b[a],arguments)}function c(a){return"number"===typeof a?"number":"string"===typeof a?"string":Object.prototype.toString.call(a).slice(8,-1).toLowerCase()}var b=/[^T]/,e=/[^v]/,f=/[diefg]/,k=/bcdiefguxXS/,g=/[j]/,n=/^[^\x25]+/,p=/^\x25{2}/,l=/^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-gijostTuvxXSDR])/,m=/^([a-z_][a-z_\d]*)/i,h=/^\.([a-z_][a-z_\d]*)/i,
q=/^\[(\d+)\]/,y=/^[\+\-]/;d.format=function(a,n){var p=1,l=a.length,m,h,q=[],t,w,D,r=!0,v;for(t=0;t<l;t++)if(m=c(a[t]),"string"===m)q[q.length]=a[t];else if("array"===m){m=a[t];if(m[2])for(h=n[p],w=0;w<m[2].length;w++){if(!h.hasOwnProperty(m[2][w]))throw Error(d('[sprintf] property "%s" does not exist',m[2][w]));h=h[m[2][w]]}else h=m[1]?n[m[1]]:n[p++];b.test(m[8])&&e.test(m[8])&&"function"==c(h)&&(h=h());if(k.test(m[8])&&"number"!=c(h)&&isNaN(h))throw new TypeError(d("[sprintf] expecting number but found %s",
c(h)));f.test(m[8])&&(r=0<=h);switch(m[8]){case "b":h=parseInt(h,10).toString(2);break;case "c":h=String.fromCharCode(parseInt(h,10));break;case "d":case "i":h=parseInt(h,10);break;case "j":h=JSON.stringify(h,null,m[6]?parseInt(m[6]):0);break;case "e":h=m[7]?parseFloat(h).toExponential(m[7]):parseFloat(h).toExponential();break;case "f":h=m[7]?parseFloat(h).toFixed(m[7]):parseFloat(h);break;case "g":h=m[7]?parseFloat(h).toPrecision(m[7]):parseFloat(h);break;case "o":h=h.toString(8);break;case "s":h=
String(h);h=m[7]?h.substring(0,m[7]):h;break;case "t":h=String(!!h);h=m[7]?h.substring(0,m[7]):h;break;case "S":if(1024>Math.abs(h))h+=" B";else{w="KiB MiB GiB TiB PiB EiB ZiB YiB".split(" ");v=-1;do h/=1024,++v;while(1024<=Math.abs(h)&&v<w.length-1);h=h.toFixed(1)+w[v]}break;case "R":v=h/Math.PI*180;h=v%1*60;w=h%1*60;h=d("%02d\u00b0 %02d' %0.2f\"",v,h,w);break;case "D":h+=Math.PI;v=h/Math.PI*12;h=v%1*60;w=h%1*60;h=d("%02dh %02dm %0.2fs",v,h,w);break;case "T":h=c(h);h=m[7]?h.substring(0,m[7]):h;break;
case "u":h=parseInt(h,10)>>>0;break;case "v":h=h.valueOf();h=m[7]?h.substring(0,m[7]):h;break;case "x":h=parseInt(h,10).toString(16);break;case "X":h=parseInt(h,10).toString(16).toUpperCase()}g.test(m[8])?q[q.length]=h:(!f.test(m[8])||r&&!m[3]?v="":(v=r?"+":"-",h=h.toString().replace(y,"")),w=m[4]?"0"===m[4]?"0":m[4].charAt(1):" ",D=m[6]-(v+h).length,D=m[6]?0<D?0<=D&&7>=D&&u[w]?u[w][D]:Array(D+1).join(w):"":"",q[q.length]=m[5]?v+h+D:"0"===w?v+D+h:D+v+h)}return q.join("")};d.cache={};d.parse=function(a){for(var b,
c=[],g=0;a;){if(null!==(b=n.exec(a)))c[c.length]=b[0];else if(null!==(b=p.exec(a)))c[c.length]="%";else if(null!==(b=l.exec(a))){if(b[2]){var g=g|1,d=[],e=b[2],k;if(null!==(k=m.exec(e)))for(d[d.length]=k[1];""!==(e=e.substring(k[0].length));)if(null!==(k=h.exec(e)))d[d.length]=k[1];else if(null!==(k=q.exec(e)))d[d.length]=k[1];else throw new SyntaxError("[sprintf] failed to parse named argument key");else throw new SyntaxError("[sprintf] failed to parse named argument key");b[2]=d}else g|=2;if(3===
...
(function(a,d,c){var b=requestAnimationFrame;a=c.Class.create("ThreeApp",null,["Events"]).ctor(function(a,b){this.frames=9999;this.viewport=a;c.extend(this.options,b)}).init(function(a,b){a=this;b=this.options;for(var c=this.options.plugins||[],g=[].concat(c),d=0;d<g.length;){var p=g[d].prototype.required;if(p&&p.length)++d;else{p=g.splice(d,1)[0];if(p.prototype.provided){for(var l=p.prototype.provided,m=0;m<g.length;m++)for(var h in l){var d=g[m].prototype.required,q=(d||[]).indexOf(h);-1!=q&&d.splice(q,
1)}d=0}l=p.name;c[m]=new p(this,b[l]);a.wait&&a.wait(c[m])}}if(g.length){for(m=0;m<g.length;m++)l=g[m].name,d=g[m].prototype.required,console.warn(l,"is missing",d);throw Error("Missing or circular dependencies");}a.plugins=c}).ready(function(){var a=this;this.options.start&&window.setTimeout(function(){a.start()},0)}).method("start",function(){var a=this;a.started||a.paused||(b(function(){a.render.call(a)}),a.started=!0)}).method("resize",function(a,b){this.width=a;this.height=b;this.invoke("resized")}).method("log",
function(){console.log(sprintf.apply(this,arguments))}).method("warn",function(){console.warn(sprintf.apply(this,arguments))}).method("info",function(){console.info(sprintf.apply(this,arguments))}).method("render",function(){var a=this;a.invoke("preframe");a.invoke("render");a.invoke("postframe");a.started&&b(function(){a.render.call(a)});++a.frames});c("App",a)})(self,THREE,THREEAPP);
(function(a,d){a=d.Class.create("LZMA",null,["Plugin"]).proto("provides","lzma").ctor(function(a){a.wlzma=new WLZMA.Manager(3)});d("Plugin.LZMA",a)})(THREE,THREEAPP);(function(a,d){a=d.Class.create("Tween",null,["Plugin"]).proto("provides","tween").ready(function(a){a.listen("preframe",function(){TWEEN.update()})});d("Plugin.Tween",a)})(THREE,THREEAPP);
(function(a,d){d("CPUs",function(a,b){function d(a,b){for(var c=[],g=0,e=0,k=setInterval(function(){for(var a=0;100>a;a++);},0),f=0;f<a;f++)c[f]=new Worker(n),c[f].onmessage=function(c){e+=c.data;++g==a&&(k&&clearInterval(k),b.call(this,e))};for(f=0;f<a;f++)c[f].postMessage("start")}function f(a,b){d(a,function(c){if(g>c)return b.call(this,k);if(12<a)return console.info("CPUs",a),b.call(this,a);k=a;g=c;f(2*a,b)})}var k=0,g=0;a=a.replace(/[/]*$/,"/");var n=a+"Worker.js";f(1,b)})})(THREE,THREEAPP);
...
(function(a,d){a=d.Class.create("Scheduler",null,["Plugin"]).proto("provides","scheduler").ctor(function(a){a.scheduler=new d.Scheduler(a)}).init(function(a){a.listen("postframe",function(){a.scheduler.frame()})});d("Plugin.Scheduler",a)})(THREE,THREEAPP);
(function(a,d){function c(a,b){var c=b.buffers();if(0!=c.size){a.task=b;b.worker=a;this.load+=1;var d=[],e=[];d.push(c.size);d.push(c.cmds||0);d.push(c.args);b.invoke("updateUniforms");d.push(c.uniforms);var f=c.input,h=c.shareds,q=f?f.length:0,y=h.length;d.push(q+y);for(var t=0;t<q;t++)d.push(f[t]);for(t=0;t<y;t++)d.push(h[t]);f=c.backups;c=c.uniforms;h=f.length;for(t=0;t<h;t++)d.push(f[t]);for(t=0;t<d.length;t++)d[t]&&d[t].buffer&&e.push(d[t].buffer);for(t=0;t<c.length;t++)c[t]&&c[t].buffer&&e.push(c[t].buffer);
a.t_start=Date.now();b.invoke("calculate",a);this.invoke("calculate",b,a);a.postMessage(d,e);a.idle=!1}}function b(a){var b=this.task,d=this.parent,e=a.data[0],f=a.data[1],m=a.data[2],h=a.data[3],q=b.tbuffers;f&&!isNaN(f.length)&&(q.cmds=f);q.args=m;q.uniforms=h;f=q.input;h=q.backups;m=q.shareds;q.backups=q.results;q.results=h;f=f?f.length:0;m=m.length;for(h=0;h<f;h++)q.input[h]=a.data[5+h];for(h=0;h<m;h++)q.shareds[h]=a.data[5+f+h];for(var y=a.data.length-5-f-m,h=0;h<y;h++)q.results[h]=a.data[5+
f+m+h];--d.load;d.tasks+=e;d.batches+=1;this.task=b.worker=null;this.idle=!0;this.t_result=Date.now();this.t_busy+=this.t_result-this.t_start;0<d.queue.length&&(a=d.queue.shift(),a.queued=!1,c.call(d,this,a));d.invoke("calculated",b,this);b.invoke("calculated",this)}function e(a){if(a.data.run)this.onmessage=b;else throw Error("unexpected message");}var f=0;a=d.Class.create("Tasker",null,["Events","Options"]).ctor(function(){this.PLUGINS={};this.plugins=[];this.workers=[];this.queue=[];this.batches=
...
(function(a,d){a=d.Class.virtual(d.Group).ctor(function(){this.worker=null;this.queued=!1;this.tbuffers={size:0,busy:!1,stale:!0,allocated:0,results:[],backups:[],shareds:[],uniforms:[],args:[]}}).method("buffers",function(a){if(this.tbuffers.stale){a=this.items.length;var b=this.tbuffers.allocated,d=this.options.hardLimit,f=this.options.increment,k=this.api.cmds;if(0!=a){for(;a>b;)b=Math.min(d,Math.max(10,b)*f);for(var d=[],f=[],g=[],n=this.api.results||[],p=this.api.shared||[],l=0;l<n.length;l++){var m=
isNaN(n[l])?n[l].length:n[l],m=0>m?-m:m*b;d[l]=new Float32Array(m);f[l]=new Float32Array(m)}for(l=0;l<p.length;l++)m=isNaN(p[l])?p[l].length:p[l],m=0>m?-m:m,g[l]=new Float32Array(m);"string"==typeof k&&(k=this.tasker.PLUGINS[k].id);this.tbuffers={size:a,busy:!1,stale:!1,allocated:b,results:d,backups:f,shareds:g,uniforms:new Float32Array(this.api.uniforms),args:new Float32Array(this.api.args*b),cmds:isNaN(k)?new Float32Array(b):k}}this.tbuffers.stale=!1;this.invoke("syncArguments");this.tbuffers.size=
...
var StatsCPU=function(a){function d(a,b,c){a=document.createElement(a);a.id=b;a.style.cssText=c;return a}function c(a,b,c,g){var e=d("div",a,"padding:0 0 3px 3px;text-align:left;background:"+c),n=d("div",a+"Text","font-family:Tahoma,Helvetica,Arial,sans-serif;font-size:8px;font-weight:bold;line-height:15px;color:"+b);n.innerHTML=a.toUpperCase();e.appendChild(n);n=94/g;a=d("div",a+"Graph","width:94px;height:30px;background:"+b);e.appendChild(a);for(b=0;b<g;b++){var f=parseInt(n)==n?n+"px":100/g+"%";
a.appendChild(d("span","","width:"+f+";height:30px;float:left;opacity:0.9;background:"+c))}return e}function b(a){for(var b=t.children,c=0;c<b.length;c++)b[c].style.display=c===a?"block":"none";m=a}function e(b,c){Date.now();if(b.firstChild)for(G.style.background="rgba("+7*q+", 64, 0, 1)",c=0;c<b.children.length;c++){var d=y[c]||0;a.workers[c].idle||(d=1);b.children[c].style.height=Math.max(Math.min(30,30-30*d),.25)+"px"}}function f(a,b){a.appendChild(a.firstChild).style.height=Math.max(Math.min(30,
30-30*b),.25)+"px"}function k(){for(var a=Date.now(),b=a-L,c=0;c<app.tasker.workers.length;c++)I[c]&&(y[c]=(app.tasker.workers[c].t_busy-I[c])/b),I[c]=app.tasker.workers[c].t_busy;L=a}function g(a){var b="";1E10<=a?(a/=1E9,b="G"):1E7<=a?(a/=1E6,b="M"):1E4<=a&&(a/=1E3,b="K");a=parseInt(a);return a+b}var n=self.performance&&self.performance.now?self.performance.now.bind(performance):Date.now,p=n(),l=p,m=0,h=0,q=0;setInterval(function(){h++},20);setInterval(function(){q=Math.abs(50-h);h=0},1E3);var y=
[],t=d("div","statsCPU","width:100px;opacity:0.9;cursor:pointer");t.addEventListener("mousedown",function(a){a.preventDefault();b(++m%t.children.length)},!1);var u=0,z=0,x=c("tasks","#306","#ccc",94),M=x.children[0],N=x.children[1];t.appendChild(x);var A=0,E=0,x=c("batches","#09f","#ccc",94),F=x.children[0],C=x.children[1];t.appendChild(x);var w=0,D=0,x=c("queues","#99f","#339",94),r=x.children[0],v=x.children[1];t.appendChild(x);var G,J,K,I=[],L=0;a.listen("ready",function(){G=c("workers","#0f0",
"#020",a.threads);J=G.children[0];K=G.children[1];t.appendChild(G);b(3);for(var d=0;d<a.threads;d+=1)a.workers[d].busy=0,a.workers[d].idling=0;setInterval(k,1E3)});b(m);return{REVISION:14,domElement:t,setMode:b,begin:function(){p=n()},end:function(){var b=n();if(b>l+250){u=Math.round(1E3*a.tasks/(b-l));z=Math.max(z,u);M.textContent=g(u)+" TSK ("+g(z)+")";f(N,u/z);A=Math.round(1E3*a.batches/(b-l));E=Math.max(E,A);F.textContent=g(A)+" BAT ("+g(E)+")";f(C,A/E);w=Math.round(1E3*a.queue.length/(b-l));
D=Math.max(D,w);r.textContent=g(w)+" QUE ("+g(D)+")";f(v,w/D);if(K){e(K);var c=a.isIdle()?"":"BSY";J.textContent="CPUS "+c+" ("+a.threads+")";for(c=0;c<a.workers.length;c+=1)a.workers[c].busy=0,a.workers[c].idling=0}l=b;a.tasks=0;a.batches=0}return b},update:function(){p=this.end();e(K)}}};"object"===typeof module&&(module.exports=StatsCPU);
...
a.byteLength)this.buffers.push(a.slice(0,c));else throw Error("Buffer too small?");this.size+=c};a.oStream.prototype.toUint8Array=function(){var a=this.size,c=this.buffers;if(1==c.length)return c[0];try{for(var b=new Uint8Array(a),e=0,f=0;e<c.length;e++)b.set(c[e],f),f+=c[e].length;c[0]=b;c.length=1;return b}catch(k){console.error("Error allocating Uint8Array of size: ",a),console.error("Message given was: ",k.toString())}return null};a.oStream.prototype.forEach=function(a){for(var c=0;c<this.buffers.length;c++)a.call(this,
this.buffers[c])};a.oStream.prototype.toCodePoints=function(){a.UTF8||this.toUint8Array();return a.UTF8.decode(this.toUint8Array())};a.oStream.prototype.toString=function(){var d=this.buffers,c="";a.UTF8&&(d=[this.toCodePoints()]);for(var b=0,e=d.length;b<e;b++)for(var f=0,k=d[b].length;f<k;f++)c+=String.fromCharCode(d[b][f]);return c}})(LZMA);var UTF8=UTF8||{};
(function(a){function d(a){for(var b=0,c=a.length;c--;)128!=(a[c]&192)&&++b;return b}function c(){if(k>=f)throw Error("Invalid byte index");var a=e[k++]&255;if(128==(a&192))return a&63;throw Error("Invalid continuation byte");}function b(){var a,b,d,l;if((k|0)>(f|0))throw Error("Invalid byte index");a=e[k]&255;k=k+1|0;if(0==(a&128))return a;if(192==(a&224)){b=c();a=(a&31)<<6|b;if(128<=a)return a;throw Error("Invalid continuation byte");}if(224==(a&240)){b=c();d=c();a=(a&15)<<12|b<<6|d;if(2048<=a){if(55296<=
a&&57343>=a)throw Error("Lone surrogate U+"+a.toString(16).toUpperCase()+" is not a scalar value");return a}throw Error("Invalid continuation byte");}if(240==(a&248)&&(b=c(),d=c(),l=c(),a=(a&7)<<18|b<<12|d<<6|l,65536<=a&&1114111>=a))return a;throw Error("Invalid UTF-8 detected");}var e,f,k;a.count=d;a.decode=function(a){var c=0,p=d(a),p=new Uint16Array(p);k=0;e=a;f=a.length;for(2<(f|0)&239==(e[0]|0)&187==(e[1]|0)&191==(e[2]|0)&&(k=3);(k|0)<(f|0);)a=b()|0,p[c++]=a;return p};"undefined"!=typeof LZMA&&
...
}function f(){for(;this.queue.length&&this.idle;){var a=this.next,b=this.queue.shift();"function"==typeof b[0]&&(b[0]=b[0].call(this));var c=this.workers[a];if(!c)debugger;c.postMessage([a,b[0]],[b[0]]);c.resolve=b[1];c.reject=b[2];c.idle=!1;for(--this.idle;a<this.workers.length;a++)if(this.workers[a].idle){this.next=a;return}this.next=-1}}function k(b){"object"==typeof b&&(b instanceof a.iStream&&(b=b.array),b instanceof Uint8Array&&(b=b.buffer));return b}d.wrkurl=d.wrkurl||"wlzma.wrk.js";d.Manager=
...
c){function b(a){return a&&a.__esModule?a:{default:a}}d.__esModule=!0;a=c(2);a=b(a);var e=c(6),e=b(e),f=c(3),f=b(f),k=c(7),k=b(k),g=c(8),g=b(g),n=c(10),n=b(n),p=c(11),p=b(p),l=c(12),l=b(l),m=c(13),m=b(m),h=c(14),h=b(h),q=c(15),q=b(q),y=c(16),y=b(y),t=c(9),t=b(t);c=c(17);c=b(c);d.default={color:{Color:a.default,math:e.default,interpret:f.default},controllers:{Controller:k.default,BooleanController:g.default,OptionController:n.default,StringController:p.default,NumberController:l.default,NumberControllerBox:m.default,
NumberControllerSlider:h.default,FunctionController:q.default,ColorController:y.default},dom:{dom:t.default},gui:{GUI:c.default},GUI:c.default}},function(a,d,c){function b(a){return a&&a.__esModule?a:{default:a}}function e(a,b,c){Object.defineProperty(a,b,{get:function(){if("RGB"===this.__state.space)return this.__state[b];l.recalculateRGB(this,b,c);return this.__state[b]},set:function(a){"RGB"!==this.__state.space&&(l.recalculateRGB(this,b,c),this.__state.space="RGB");this.__state[b]=a}})}function f(a,
b){Object.defineProperty(a,b,{get:function(){if("HSV"===this.__state.space)return this.__state[b];l.recalculateHSV(this);return this.__state[b]},set:function(a){"HSV"!==this.__state.space&&(l.recalculateHSV(this),this.__state.space="HSV");this.__state[b]=a}})}d.__esModule=!0;a=c(3);var k=b(a);a=c(6);var g=b(a);a=c(4);var n=b(a);c=c(5);var p=b(c),l=function(){function a(){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");this.__state=k.default.apply(this,arguments);if(!1===
this.__state)throw Error("Failed to interpret color arguments");this.__state.a=this.__state.a||1}a.prototype.toString=function(){return(0,n.default)(this)};a.prototype.toHexString=function(){return(0,n.default)(this,!0)};a.prototype.toOriginal=function(){return this.__state.conversion.write(this)};return a}();l.recalculateRGB=function(a,b,c){if("HEX"===a.__state.space)a.__state[b]=g.default.component_from_hex(a.__state.hex,c);else if("HSV"===a.__state.space)p.default.extend(a.__state,g.default.hsv_to_rgb(a.__state.h,
a.__state.s,a.__state.v));else throw Error("Corrupted color state");};l.recalculateHSV=function(a){var b=g.default.rgb_to_hsv(a.r,a.g,a.b);p.default.extend(a.__state,{s:b.s,v:b.v});p.default.isNaN(b.h)?p.default.isUndefined(a.__state.h)&&(a.__state.h=0):a.__state.h=b.h};l.COMPONENTS="r g b h s v hex a".split(" ");e(l.prototype,"r",2);e(l.prototype,"g",1);e(l.prototype,"b",0);f(l.prototype,"h");f(l.prototype,"s");f(l.prototype,"v");Object.defineProperty(l.prototype,"a",{get:function(){return this.__state.a},
set:function(a){this.__state.a=a}});Object.defineProperty(l.prototype,"hex",{get:function(){this.__state.hex=g.default.rgb_to_hex(this.r,this.g,this.b);return this.__state.hex},set:function(a){this.__state.space="HEX";this.__state.hex=a}});d.default=l},function(a,d,c){d.__esModule=!0;a=(a=c(4))&&a.__esModule?a:{default:a};var b=(c=c(5))&&c.__esModule?c:{default:c},e=[{litmus:b.default.isString,conversions:{THREE_CHAR_HEX:{read:function(a){a=a.match(/^#([A-F0-9])([A-F0-9])([A-F0-9])$/i);return null===
...
f=void 0,k=void 0;d.default=function(){k=!1;var a=1<arguments.length?b.default.toArray(arguments):arguments[0];b.default.each(e,function(c){if(c.litmus(a))return b.default.each(c.conversions,function(c,d){f=c.read(a);if(!1===k&&!1!==f)return k=f,f.conversionName=d,f.conversion=c,b.default.BREAK}),b.default.BREAK});return k}},function(a,d){d.__esModule=!0;d.default=function(a,b){var d=a.__state.conversionName.toString(),f=Math.round(a.r),k=Math.round(a.g),g=Math.round(a.b),n=a.a,p=Math.round(a.h),
l=a.s.toFixed(1),m=a.v.toFixed(1);if(b||"THREE_CHAR_HEX"===d||"SIX_CHAR_HEX"===d){for(a=a.hex.toString(16);6>a.length;)a="0"+a;return"#"+a}return"CSS_RGB"===d?"rgb("+f+","+k+","+g+")":"CSS_RGBA"===d?"rgba("+f+","+k+","+g+","+n+")":"HEX"===d?"0x"+a.hex.toString(16):"RGB_ARRAY"===d?"["+f+","+k+","+g+"]":"RGBA_ARRAY"===d?"["+f+","+k+","+g+","+n+"]":"RGB_OBJ"===d?"{r:"+f+",g:"+k+",b:"+g+"}":"RGBA_OBJ"===d?"{r:"+f+",g:"+k+",b:"+g+",a:"+n+"}":"HSV_OBJ"===d?"{h:"+p+",s:"+l+",v:"+m+"}":"HSVA_OBJ"===d?"{h:"+
p+",s:"+l+",v:"+m+",a:"+n+"}":"unknown format"}},function(a,d){d.__esModule=!0;var c=Array.prototype.forEach,b=Array.prototype.slice;a={BREAK:{},extend:function(a){this.each(b.call(arguments,1),function(b){(this.isObject(b)?Object.keys(b):[]).forEach(function(c){this.isUndefined(b[c])||(a[c]=b[c])}.bind(this))},this);return a},defaults:function(a){this.each(b.call(arguments,1),function(b){(this.isObject(b)?Object.keys(b):[]).forEach(function(c){this.isUndefined(a[c])&&(a[c]=b[c])}.bind(this))},this);
return a},compose:function(){var a=b.call(arguments);return function(){for(var c=b.call(arguments),d=a.length-1;0<=d;d--)c=[a[d].apply(this,c)];return c[0]}},each:function(a,b,d){if(a)if(c&&a.forEach&&a.forEach===c)a.forEach(b,d);else if(a.length===a.length+0){var g,n;g=0;for(n=a.length;g<n&&!(g in a&&b.call(d,a[g],g)===this.BREAK);g++);}else for(g in a)if(b.call(d,a[g],g)===this.BREAK)break},defer:function(a){setTimeout(a,0)},debounce:function(a,b){var c=void 0;return function(){var d=arguments,
n=!c;clearTimeout(c);c=setTimeout(function(){c=null},b);n&&a.apply(this,d)}},toArray:function(a){return a.toArray?a.toArray():b.call(a)},isUndefined:function(a){return void 0===a},isNull:function(a){return null===a},isNaN:function(a){function b(c){return a.apply(this,arguments)}b.toString=function(){return a.toString()};return b}(function(a){return isNaN(a)}),isArray:Array.isArray||function(a){return a.constructor===Array},isObject:function(a){return a===Object(a)},isNumber:function(a){return a===
a+0},isString:function(a){return a===a+""},isBoolean:function(a){return!1===a||!0===a},isFunction:function(a){return"[object Function]"===Object.prototype.toString.call(a)}};d.default=a},function(a,d){d.__esModule=!0;var c=void 0;d.default={hsv_to_rgb:function(a,c,d){var k=a/60-Math.floor(a/60),g=d*(1-c),n=d*(1-k*c);c=d*(1-(1-k)*c);a=[[d,c,g],[n,d,g],[g,d,c],[g,n,d],[c,g,d],[d,g,n]][Math.floor(a/60)%6];return{r:255*a[0],g:255*a[1],b:255*a[2]}},rgb_to_hsv:function(a,c,d){var k=Math.max(a,c,d),g=k-
Math.min(a,c,d);if(0===k)return{h:NaN,s:0,v:0};a=(a===k?(c-d)/g:c===k?2+(d-a)/g:4+(a-c)/g)/6;0>a&&(a+=1);return{h:360*a,s:g/k,v:k/255}},rgb_to_hex:function(a,c,d){a=this.hex_with_component(0,2,a);a=this.hex_with_component(a,1,c);return a=this.hex_with_component(a,0,d)},component_from_hex:function(a,c){return a>>8*c&255},hex_with_component:function(a,d,f){return f<<(c=8*d)|a&~(255<<c)}}},function(a,d){d.__esModule=!0;a=function(){function a(b,d){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");
...
enumerable:!1,writable:!0,configurable:!0}});b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}d.__esModule=!0;a=(a=c(7))&&a.__esModule?a:{default:a};var f=(c=c(9))&&c.__esModule?c:{default:c};c=function(a){function c(d,e){if(!(this instanceof c))throw new TypeError("Cannot call a class as a function");var l=b(this,a.call(this,d,e));l.__prev=l.getValue();l.__checkbox=document.createElement("input");l.__checkbox.setAttribute("type","checkbox");f.default.bind(l.__checkbox,"change",
function(){l.setValue(!l.__prev)},!1);l.domElement.appendChild(l.__checkbox);l.updateDisplay();return l}e(c,a);c.prototype.setValue=function(b){b=a.prototype.setValue.call(this,b);this.__onFinishChange&&this.__onFinishChange.call(this,this.getValue());this.__prev=this.getValue();return b};c.prototype.updateDisplay=function(){!0===this.getValue()?(this.__checkbox.setAttribute("checked","checked"),this.__checkbox.checked=!0):this.__checkbox.checked=!1;return a.prototype.updateDisplay.call(this)};return c}(a.default);
d.default=c},function(a,d,c){function b(a){if("0"===a||e.default.isUndefined(a))return 0;a=a.match(k);return e.default.isNull(a)?0:parseFloat(a[1])}d.__esModule=!0;var e=(a=c(5))&&a.__esModule?a:{default:a},f={};e.default.each({HTMLEvents:["change"],MouseEvents:["click","mousemove","mousedown","mouseup","mouseover"],KeyboardEvents:["keydown"]},function(a,b){e.default.each(a,function(a){f[a]=b})});var k=/(\d+(\.\d+)?)px/,g={makeSelectable:function(a,b){void 0!==a&&void 0!==a.style&&(a.onselectstart=
b?function(){return!1}:function(){},a.style.MozUserSelect=b?"auto":"none",a.style.KhtmlUserSelect=b?"auto":"none",a.unselectable=b?"on":"off")},makeFullscreen:function(a,b,c){e.default.isUndefined(b)&&(b=!0);e.default.isUndefined(c)&&(c=!0);a.style.position="absolute";b&&(a.style.left=0,a.style.right=0);c&&(a.style.top=0,a.style.bottom=0)},fakeEvent:function(a,b,c,d){c=c||{};var g=f[b];if(!g)throw Error("Event type "+b+" not supported.");var k=document.createEvent(g);switch(g){case "MouseEvents":k.initMouseEvent(b,
c.bubbles||!1,c.cancelable||!0,window,c.clickCount||1,0,0,c.x||c.clientX||0,c.y||c.clientY||0,!1,!1,!1,!1,0,null);break;case "KeyboardEvents":g=k.initKeyboardEvent||k.initKeyEvent;e.default.defaults(c,{cancelable:!0,ctrlKey:!1,altKey:!1,shiftKey:!1,metaKey:!1,keyCode:void 0,charCode:void 0});g(b,c.bubbles||!1,c.cancelable,window,c.ctrlKey,c.altKey,c.shiftKey,c.metaKey,c.keyCode,c.charCode);break;default:k.initEvent(b,c.bubbles||!1,c.cancelable||!0)}e.default.defaults(k,d);a.dispatchEvent(k)},bind:function(a,
...
typeof b?a:b}function f(a,b){if("function"!==typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function, not "+typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}d.__esModule=!0;a=c(7);a=b(a);var k=c(9),g=b(k);c=c(5);var n=b(c);c=function(a){function b(c,d,f){if(!(this instanceof b))throw new TypeError("Cannot call a class as a function");
var k=e(this,a.call(this,c,d)),t=f;k.__select=document.createElement("select");n.default.isArray(t)&&function(){var a={};n.default.each(t,function(b){a[b]=b});t=a}();n.default.each(t,function(a,b){var c=document.createElement("option");c.innerHTML=b;c.setAttribute("value",a);k.__select.appendChild(c)});k.updateDisplay();g.default.bind(k.__select,"change",function(){k.setValue(this.options[this.selectedIndex].value)});k.domElement.appendChild(k.__select);return k}f(b,a);b.prototype.setValue=function(b){b=
...
a.length-a.indexOf(".")-1:0}d.__esModule=!0;a=(a=c(7))&&a.__esModule?a:{default:a};var f=(c=c(5))&&c.__esModule?c:{default:c};c=function(a){function c(b,d,l){if(!(this instanceof c))throw new TypeError("Cannot call a class as a function");b=a.call(this,b,d);if(!this)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");b=!b||"object"!==typeof b&&"function"!==typeof b?this:b;l=l||{};b.__min=l.min;b.__max=l.max;b.__step=l.step;f.default.isUndefined(b.__step)?b.__impliedStep=
...
typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}d.__esModule=!0;a=c(12);a=b(a);var k=c(9),g=b(k);c=c(5);var n=b(c);c=function(a){function b(c,d,f){function k(){z.__onFinishChange&&z.__onFinishChange.call(z,z.getValue())}function t(a){var b=x-a.clientY;z.setValue(z.getValue()+b*z.__impliedStep);x=a.clientY}function u(){g.default.unbind(document,"mousemove",t);g.default.unbind(document,
"mouseup",u);k()}if(!(this instanceof b))throw new TypeError("Cannot call a class as a function");c=e(this,a.call(this,c,d,f));c.__truncationSuspended=!1;var z=c,x=void 0;c.__input=document.createElement("input");c.__input.setAttribute("type","text");g.default.bind(c.__input,"change",function(){var a=parseFloat(z.__input.value);n.default.isNaN(a)||z.setValue(a)});g.default.bind(c.__input,"blur",function(){k()});g.default.bind(c.__input,"mousedown",function(a){g.default.bind(document,"mousemove",t);
g.default.bind(document,"mouseup",u);x=a.clientY});g.default.bind(c.__input,"keydown",function(a){13===a.keyCode&&(z.__truncationSuspended=!0,this.blur(),z.__truncationSuspended=!1,k())});c.updateDisplay();c.domElement.appendChild(c.__input);return c}f(b,a);b.prototype.updateDisplay=function(){var b=this.__input,c;if(this.__truncationSuspended)c=this.getValue();else{c=this.getValue();var d=Math.pow(10,this.__precision);c=Math.round(c*d)/d}b.value=c;return a.prototype.updateDisplay.call(this)};return b}(a.default);
...
b)}function f(a,b,c,d,e){return d+(a-b)/(c-b)*(e-d)}d.__esModule=!0;a=(a=c(12))&&a.__esModule?a:{default:a};var k=(c=c(9))&&c.__esModule?c:{default:c};c=function(a){function c(d,e,m,h,q){function y(a){a.preventDefault();var b=u.__background.getBoundingClientRect();u.setValue(f(a.clientX,b.left,b.right,u.__min,u.__max));return!1}function t(){k.default.unbind(document,"mousemove",y);k.default.unbind(document,"mouseup",t);u.__onFinishChange&&u.__onFinishChange.call(u,u.getValue())}if(!(this instanceof
c))throw new TypeError("Cannot call a class as a function");var u=d=b(this,a.call(this,d,e,{min:m,max:h,step:q}));d.__background=document.createElement("div");d.__foreground=document.createElement("div");k.default.bind(d.__background,"mousedown",function(a){document.activeElement.blur();k.default.bind(document,"mousemove",y);k.default.bind(document,"mouseup",t);y(a)});k.default.addClass(d.__background,"slider");k.default.addClass(d.__foreground,"slider-fg");d.updateDisplay();d.__background.appendChild(d.__foreground);
...
b)}function k(a,b,c,d){a.style.background="";h.default.each(q,function(e){a.style.cssText+="background: "+e+"linear-gradient("+b+", "+c+" 0%, "+d+" 100%); "})}function g(a){a.style.background="";a.style.cssText+="background: -moz-linear-gradient(top,  #ff0000 0%, #ff00ff 17%, #0000ff 34%, #00ffff 50%, #00ff00 67%, #ffff00 84%, #ff0000 100%);";a.style.cssText+="background: -webkit-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);";a.style.cssText+=
"background: -o-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);";a.style.cssText+="background: -ms-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);";a.style.cssText+="background: linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);"}d.__esModule=!0;a=c(7);a=b(a);var n=c(9),p=b(n),n=c(2),l=b(n),n=c(3),m=b(n);c=c(5);var h=b(c);
c=function(a){function b(c,d){function f(a){F(a);p.default.bind(document,"mousemove",F);p.default.bind(document,"mouseup",n)}function n(){p.default.unbind(document,"mousemove",F);p.default.unbind(document,"mouseup",n);E()}function q(){var a=(0,m.default)(this.value);!1!==a?(w.__color.__state=a,w.setValue(w.__color.toOriginal())):this.value=w.__color.toString()}function A(){p.default.unbind(document,"mousemove",C);p.default.unbind(document,"mouseup",A);E()}function E(){w.__onFinishChange&&w.__onFinishChange.call(w,
...
b))throw new TypeError("Cannot call a class as a function");c=e(this,a.call(this,c,d));c.__color=new l.default(c.getValue());c.__temp=new l.default(0);var w=c;c.domElement=document.createElement("div");p.default.makeSelectable(c.domElement,!1);c.__selector=document.createElement("div");c.__selector.className="selector";c.__saturation_field=document.createElement("div");c.__saturation_field.className="saturation-field";c.__field_knob=document.createElement("div");c.__field_knob.className="field-knob";
...
function(){p.default.removeClass(w.__selector,"drag")})});d=document.createElement("div");h.default.extend(c.__selector.style,{width:"122px",height:"102px",padding:"3px",backgroundColor:"#222",boxShadow:"0px 1px 3px rgba(0,0,0,0.3)"});h.default.extend(c.__field_knob.style,{position:"absolute",width:"12px",height:"12px",border:c.__field_knob_border+(.5>c.__color.v?"#fff":"#000"),boxShadow:"0px 1px 3px rgba(0,0,0,0.5)",borderRadius:"12px",zIndex:1});h.default.extend(c.__hue_knob.style,{position:"absolute",
width:"15px",height:"2px",borderRight:"4px solid #fff",zIndex:1});h.default.extend(c.__saturation_field.style,{width:"100px",height:"100px",border:"1px solid #555",marginRight:"3px",display:"inline-block",cursor:"pointer"});h.default.extend(d.style,{width:"100%",height:"100%",background:"none"});k(d,"top","rgba(0,0,0,0)","#000");h.default.extend(c.__hue_field.style,{width:"15px",height:"100px",border:"1px solid #555",cursor:"ns-resize",position:"absolute",top:"3px",right:"3px"});g(c.__hue_field);
h.default.extend(c.__input.style,{outline:"none",textAlign:"center",color:"#fff",border:0,fontWeight:"bold",textShadow:c.__input_textShadow+"rgba(0,0,0,0.7)"});p.default.bind(c.__saturation_field,"mousedown",f);p.default.bind(c.__field_knob,"mousedown",f);p.default.bind(c.__hue_field,"mousedown",function(a){C(a);p.default.bind(document,"mousemove",C);p.default.bind(document,"mouseup",A)});c.__saturation_field.appendChild(d);c.__selector.appendChild(c.__field_knob);c.__selector.appendChild(c.__saturation_field);
c.__selector.appendChild(c.__hue_field);c.__hue_field.appendChild(c.__hue_knob);c.domElement.appendChild(c.__input);c.domElement.appendChild(c.__selector);c.updateDisplay();return c}f(b,a);b.prototype.updateDisplay=function(){var a=(0,m.default)(this.getValue());if(!1!==a){var b=!1;h.default.each(l.default.COMPONENTS,function(c){if(!h.default.isUndefined(a[c])&&!h.default.isUndefined(this.__color.__state[c])&&a[c]!==this.__color.__state[c])return b=!0,{}},this);b&&h.default.extend(this.__color.__state,
a)}h.default.extend(this.__temp.__state,this.__color.__state);this.__temp.a=1;var c=.5>this.__color.v||.5<this.__color.s?255:0,d=255-c;h.default.extend(this.__field_knob.style,{marginLeft:100*this.__color.s-7+"px",marginTop:100*(1-this.__color.v)-7+"px",backgroundColor:this.__temp.toHexString(),border:this.__field_knob_border+"rgb("+c+","+c+","+c+")"});this.__hue_knob.style.marginTop=100*(1-this.__color.h/360)+"px";this.__temp.s=1;this.__temp.v=1;k(this.__saturation_field,"left","#fff",this.__temp.toHexString());
...
function f(a,b){a=a.__preset_select[a.__preset_select.selectedIndex];a.innerHTML=b?a.value+"*":a.value}function k(a,b,c){c.__li=b;c.__gui=a;v.default.extend(c,{options:function(b){if(1<arguments.length){var d=c.__li.nextElementSibling;c.remove();return n(a,c.object,c.property,{before:d,factoryArgs:[v.default.toArray(arguments)]})}if(v.default.isArray(b)||v.default.isObject(b))return d=c.__li.nextElementSibling,c.remove(),n(a,c.object,c.property,{before:d,factoryArgs:[b]})},name:function(a){c.__li.firstElementChild.firstElementChild.innerHTML=
...
else if(c instanceof E.default){var d=function(b){if(v.default.isNumber(c.__min)&&v.default.isNumber(c.__max)){b=c.__li.firstElementChild.firstElementChild.innerHTML;var d=-1<c.__gui.__listening.indexOf(c);c.remove();var e=n(a,c.object,c.property,{before:c.__li.nextElementSibling,factoryArgs:[c.__min,c.__max,c.__step]});e.name(b);d&&e.listen();return e}return b};c.min=v.default.compose(d,c.min);c.max=v.default.compose(d,c.max)}else c instanceof N.default?(r.default.bind(b,"click",function(){r.default.fakeEvent(c.__checkbox,
...
a);c.revert()}},width:{get:function(){return d.width},set:function(a){d.width=a;h(c,a)}},name:{get:function(){return d.name},set:function(a){d.name=a;titleRowName&&(titleRowName.innerHTML=d.name)}},closed:{get:function(){return d.closed},set:function(a){d.closed=a;d.closed?r.default.addClass(c.__ul,H.CLASS_CLOSED):r.default.removeClass(c.__ul,H.CLASS_CLOSED);this.onResize();c.__closeButton&&(c.__closeButton.innerHTML=a?H.TEXT_OPEN:H.TEXT_CLOSED)}},load:{get:function(){return d.load}},useLocalStorage:{get:function(){return f},
...
function(a,d,c){function b(a){return a&&a.__esModule?a:{default:a}}d.__esModule=!0;a=c(10);var e=b(a);a=c(13);var f=b(a);a=c(14);var k=b(a);a=c(11);var g=b(a);a=c(15);var n=b(a);a=c(8);var p=b(a);c=c(5);var l=b(c);d.default=function(a,b,c,d,t){var u=a[b];return l.default.isArray(c)||l.default.isObject(c)?new e.default(a,b,c):l.default.isNumber(u)?l.default.isNumber(c)&&l.default.isNumber(d)?l.default.isNumber(t)?new k.default(a,b,c,d,t):new k.default(a,b,c,d):l.default.isNumber(t)?new f.default(a,
b,{min:c,max:d,step:t}):new f.default(a,b,{min:c,max:d}):l.default.isString(u)?new g.default(a,b):l.default.isFunction(u)?new n.default(a,b,""):l.default.isBoolean(u)?new p.default(a,b):null}},function(a,d){function c(a){setTimeout(a,1E3/60)}d.__esModule=!0;d.default=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||c},function(a,d,c){d.__esModule=!0;var b=(a=c(9))&&a.__esModule?a:{default:a},
...
""])},function(a,d){a.exports=function(){var a=[];a.toString=function(){for(var a=[],c=0;c<this.length;c++){var d=this[c];d[2]?a.push("@media "+d[2]+"{"+d[1]+"}"):a.push(d[1])}return a.join("")};a.i=function(b,d){"string"===typeof b&&(b=[[null,b,""]]);for(var f={},k=0;k<this.length;k++){var g=this[k][0];"number"===typeof g&&(f[g]=!0)}for(k=0;k<b.length;k++)g=b[k],"number"===typeof g[0]&&f[g[0]]||(d&&!g[2]?g[2]=d:d&&(g[2]="("+g[2]+") and ("+d+")"),a.push(g))};return a}}])});
...
TWEEN.Tween=function(a){var d={},c={},b={},e=1E3,f=0,k,g=!1,n=!1,p=0,l=null,m=TWEEN.Easing.Linear.None,h=TWEEN.Interpolation.Linear,q=[],y=null,t=!1,u=null,z=null,x=null;this.to=function(a,b){c=a;void 0!==b&&(e=b);return this};this.start=function(e){TWEEN.add(this);n=!0;t=!1;l=void 0!==e?e:TWEEN.now();l+=p;for(var f in c){if(c[f]instanceof Array){if(0===c[f].length)continue;c[f]=[a[f]].concat(c[f])}void 0!==a[f]&&(d[f]=a[f],!1===d[f]instanceof Array&&(d[f]*=1),b[f]=d[f]||0)}return this};this.stop=
function(){if(!n)return this;TWEEN.remove(this);n=!1;null!==x&&x.call(a,a);this.stopChainedTweens();return this};this.end=function(){this.update(l+e);return this};this.stopChainedTweens=function(){for(var a=0,b=q.length;a<b;a++)q[a].stop()};this.delay=function(a){p=a;return this};this.repeat=function(a){f=a;return this};this.repeatDelay=function(a){k=a;return this};this.yoyo=function(a){g=a;return this};this.easing=function(a){m=a;return this};this.interpolation=function(a){h=a;return this};this.chain=
function(){q=arguments;return this};this.onStart=function(a){y=a;return this};this.onUpdate=function(a){u=a;return this};this.onComplete=function(a){z=a;return this};this.onStop=function(a){x=a;return this};this.update=function(n){var x,A,E;if(n<l)return!0;!1===t&&(null!==y&&y.call(a,a),t=!0);A=(n-l)/e;A=1<A?1:A;E=m(A);for(x in c)if(void 0!==d[x]){var F=d[x]||0,C=c[x];C instanceof Array?a[x]=h(C,E):("string"===typeof C&&(C="+"===C.charAt(0)||"-"===C.charAt(0)?F+parseFloat(C):parseFloat(C)),"number"===
typeof C&&(a[x]=F+(C-F)*E))}null!==u&&u.call(a,E);if(1===A)if(0<f){isFinite(f)&&f--;for(x in b)"string"===typeof c[x]&&(b[x]+=parseFloat(c[x])),g&&(A=b[x],b[x]=c[x],c[x]=A),d[x]=b[x];l=void 0!==k?n+k:n+p}else{null!==z&&z.call(a,a);n=0;for(x=q.length;n<x;n++)q[n].start(l+e);return!1}return!0}};
