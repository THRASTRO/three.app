...
c.create=function(){var a="string"==typeof arguments[0]?[].shift.call(arguments):null,m=arguments[0]||c,h=arguments[1]||[],n=function(){this.pending=0;this.options=d.extend({},this.defaults);b.apply(this,arguments);e.apply(this,arguments)};a&&eval("Klass = "+n.toString().replace(/\(\)/,a+"()"));return f.call(c,n,m,h)};c.mixin=function(a){1>arguments.length&&(a=[]);return f.call(c,function(){throw Error("Can't instantiate mixins");},null,a)};c.virtual=function(a,b){0==arguments.length&&(a=c);if(!a)throw Error("Undefined virtual base!");
...
g[l].prototype.required,q=(d||[]).indexOf(k);-1!=q&&d.splice(q,1)}d=0}n=p.name;c[l]=new p(this,b[n]);a.wait&&a.wait(c[l])}}if(g.length){for(l=0;l<g.length;l++)n=g[l].name,d=g[l].prototype.required,console.warn(n,"is missing",d);throw Error("Missing or circular dependencies");}a.plugins=c}).ready(function(){var a=this;this.options.start&&window.setTimeout(function(){a.start()},0)}).method("start",function(){var a=this;a.started||a.paused||(b(function(){a.render.call(a)}),a.started=!0)}).method("resize",
