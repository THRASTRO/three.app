...
this.isReady=!0;return this}function g(a,c,b){c||(c=d.Class);Array.isArray(b)||(b=[b]);if(!b)throw Error("Undefined mixin!");a.prototype.ctor||(a.prototype.ctor=[]);a.prototype.init||(a.prototype.init=[]);a.prototype.ready||(a.prototype.ready=[]);a.prototype.defaults||(a.prototype.defaults={});a.prototype.listeners||(a.prototype.listeners={});if(b&&b.length)for(var e=0,g=b.length;e<g;e++){if(!b[e])throw Error("Undefined mixin!");if(!(b[e]instanceof Function)){var v=d(b[e]);if("undefined"==typeof v)throw Error("Unknown mixin: "+
b[e]);b[e]=v}}a.prototype.listeners=d.extend(!0,{},a.prototype.listeners);for(e=0;e<b.length;e++)d.mixin(a,b[e]);d.mixin(a,c);c&&(a.prototype.__proto__=c.prototype);a.static=function(c,b){a[c]=b;return this};a.method=function(c,b){a.prototype[c]=b;return this};a.proto=function(c,b){a.prototype[c](b);return this};a.defaults=function(c){d.extend(a.prototype.defaults,c);return this};a.ctor=function(c){a.prototype.ctor.push(c);return this};a.init=function(c){a.prototype.init.push(c);return this};a.ready=
function(c){a.prototype.ready.push(c);return this};a.listen=function(c,b,e){var d=a.prototype.listeners;d[c]||(d[c]=[]);null!=e&&(b.prio=e);d[c].push(b);"ready"==c&&this.isReady&&b.call(this);return this};return a}function v(a){function b(){--d.pending;c.apply(d)}function e(a){throw a;}var d=this;d.pending++;if(!a)throw Error("Invalid wait call");if("function"==typeof a.listen)a.listen("ready",b);else if("function"==typeof a.then)a.then(b,e);else throw Error("Invalid wait promise");return c.apply(d)}
e.create=function(){var b="string"==typeof arguments[0]?[].shift.call(arguments):null,h=arguments[0]||e,v=arguments[1]||[],q=function(){this.pending=0;this.options=d.extend({},this.defaults);a.apply(this,arguments);c.apply(this,arguments)};b&&eval("Klass = "+q.toString().replace(/\(\)/,b+"()"));return g.call(e,q,h,v)};e.mixin=function(a){1>arguments.length&&(a=[]);return g.call(e,function(){throw Error("Can't instantiate mixins");},null,a)};e.virtual=function(a,c){0==arguments.length&&(a=e);if(!a)throw Error("Undefined virtual base!");
2>arguments.length&&(c=[]);return g.call(e,function(){throw Error("cannot instantiate virtual class");},a,c)};e.prototype.constructor=e;d("Class",e)})(THREE,THREEAPP);(function(b,d){b=d.Class.mixin().ctor(function(b,a){this.app=b;d.extend(this.options,a)});d("Options",b)})(THREE,THREEAPP);
...
d=a.manager,e=c.resources,g;for(g in e){var m=e[g][0],n=e[g][1];this.assets[g]=e[g];if(a.resources[n]){var r={obj:this,assets:e[g]};a.resources[n].complete?e[g][2]=a.resources[n]:this.wait(new Promise(function(b,c){r.reject=c;r.resolve=b;a.resources[n].cbs.push(r)}))}else{var m=m.substr(0,1).toUpperCase(),w;if("S"==m)w=new b.TextLoader(d);else if("T"==m)w=new b.TextureLoader(d);else if("I"==m)w=new b.ImageLoader(d);else if("J"==m)w=new b.JsonLoader(d);else if("A"==m)w=new b.ArrayLoader(d);else if("B"==
m)w=new b.BlobLoader(d);else if("R"==m)w=new b.BinaryLoader(d);else if("O"==m)w=new b.ObjectLoader(d);else if("L"==m)w=new b.OBJLoader(d);else throw"Unknown loader type for resource";r={obj:this,assets:e[g]};this.wait(new Promise(function(b,d){r.reject=d;r.resolve=b;a.resources[n]={total:0,loaded:0,cbs:[r]};(function(b,e,h){w.load(e,function(b){a.invoke("loader.complete",h,b)},function(b){a.invoke("loader.progress",c,h,b)},d)})(m,n,a.resources[n])}))}}}).ready(function(){this.asset=a}).listen("ready",
...
d));return e}function e(a){for(var b=p.children,c=0;c<b.length;c++)b[c].style.display=c===a?"block":"none";h=a}function a(a,b){a.appendChild(a.firstChild).style.height=Math.min(30,30-30*b)+"px"}var c=self.performance&&self.performance.now?self.performance.now.bind(performance):Date.now,g=c(),v=g,l=0,h=0,p=b("div","statsGPU","width:100px;opacity:0.9;cursor:pointer");p.addEventListener("mousedown",function(a){a.preventDefault();e(++h%p.children.length)},!1);var q=0,m=Infinity,n=0,r=d("fps","#0ff","#002"),
w=r.children[0],x=r.children[1];p.appendChild(r);var y=0,z=Infinity,A=0,r=d("ms","#0f0","#020"),C=r.children[0],D=r.children[1];p.appendChild(r);if(self.performance&&self.performance.memory){var k=0,f=Infinity,B=0,r=d("mb","#f08","#201"),E=r.children[0],t=r.children[1];p.appendChild(r)}e(h);return{REVISION:14,domElement:p,setMode:e,begin:function(){g=c()},end:function(){var b=c();y=b-g;z=Math.min(z,y);A=Math.max(A,y);C.textContent=(y|0)+" MS ("+(z|0)+"-"+(A|0)+")";a(D,y/200);l++;if(b>v+1E3&&(q=Math.round(1E3*
l/(b-v)),m=Math.min(m,q),n=Math.max(n,q),w.textContent=q+" FPS ("+m+"-"+n+")",a(x,q/100),v=b,l=0,void 0!==k)){var d=performance.memory.usedJSHeapSize,e=performance.memory.jsHeapSizeLimit;k=Math.round(9.54E-7*d);f=Math.min(f,k);B=Math.max(B,k);E.textContent=k+" MB ("+f+"-"+B+")";a(t,d/e)}return b},update:function(){g=this.end()}}};"object"===typeof module&&(module.exports=StatsGPU);
...
(function(b){function d(){var a=arguments[0],b=d.cache;b[a]&&b.hasOwnProperty(a)||(b[a]=d.parse(a));return d.format.call(null,b[a],arguments)}function e(a){return"number"===typeof a?"number":"string"===typeof a?"string":Object.prototype.toString.call(a).slice(8,-1).toLowerCase()}var a=/[^T]/,c=/[^v]/,g=/[diefg]/,v=/bcdiefguxXS/,l=/[j]/,h=/^[^\x25]+/,p=/^\x25{2}/,q=/^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-gijostTuvxXSDR])/,m=/^([a-z_][a-z_\d]*)/i,n=/^\.([a-z_][a-z_\d]*)/i,
r=/^\[(\d+)\]/,w=/^[\+\-]/;d.format=function(b,h){var m=1,r=b.length,k,f,n=[],q,t,p,x=!0,u;for(q=0;q<r;q++)if(k=e(b[q]),"string"===k)n[n.length]=b[q];else if("array"===k){k=b[q];if(k[2])for(f=h[m],t=0;t<k[2].length;t++){if(!f.hasOwnProperty(k[2][t]))throw Error(d('[sprintf] property "%s" does not exist',k[2][t]));f=f[k[2][t]]}else f=k[1]?h[k[1]]:h[m++];a.test(k[8])&&c.test(k[8])&&"function"==e(f)&&(f=f());if(v.test(k[8])&&"number"!=e(f)&&isNaN(f))throw new TypeError(d("[sprintf] expecting number but found %s",
...
String(f);f=k[7]?f.substring(0,k[7]):f;break;case "t":f=String(!!f);f=k[7]?f.substring(0,k[7]):f;break;case "S":if(1024>Math.abs(f))f+=" B";else{t="KiB MiB GiB TiB PiB EiB ZiB YiB".split(" ");u=-1;do f/=1024,++u;while(1024<=Math.abs(f)&&u<t.length-1);f=f.toFixed(1)+t[u]}break;case "R":u=f/Math.PI*180;f=u%1*60;t=f%1*60;f=d("%02d\u00b0 %02d' %0.2f\"",u,f,t);break;case "D":f+=Math.PI;u=f/Math.PI*12;f=u%1*60;t=f%1*60;f=d("%02dh %02dm %0.2fs",u,f,t);break;case "T":f=e(f);f=k[7]?f.substring(0,k[7]):f;break;
case "u":f=parseInt(f,10)>>>0;break;case "v":f=f.valueOf();f=k[7]?f.substring(0,k[7]):f;break;case "x":f=parseInt(f,10).toString(16);break;case "X":f=parseInt(f,10).toString(16).toUpperCase()}l.test(k[8])?n[n.length]=f:(!g.test(k[8])||x&&!k[3]?u="":(u=x?"+":"-",f=f.toString().replace(w,"")),t=k[4]?"0"===k[4]?"0":k[4].charAt(1):" ",p=k[6]-(u+f).length,p=k[6]?0<p?0<=p&&7>=p&&y[t]?y[t][p]:Array(p+1).join(t):"":"",n[n.length]=k[5]?u+f+p:"0"===t?u+p+f:p+u+f)}return n.join("")};d.cache={};d.parse=function(a){for(var b,
c=[],d=0;a;){if(null!==(b=h.exec(a)))c[c.length]=b[0];else if(null!==(b=p.exec(a)))c[c.length]="%";else if(null!==(b=q.exec(a))){if(b[2]){var d=d|1,e=[],f=b[2],g;if(null!==(g=m.exec(f)))for(e[e.length]=g[1];""!==(f=f.substring(g[0].length));)if(null!==(g=n.exec(f)))e[e.length]=g[1];else if(null!==(g=r.exec(f)))e[e.length]=g[1];else throw new SyntaxError("[sprintf] failed to parse named argument key");else throw new SyntaxError("[sprintf] failed to parse named argument key");b[2]=e}else d|=2;if(3===
...
(function(b,d,e){var a=requestAnimationFrame;b=e.Class.create("ThreeApp",null,["Events","Options"]).defaults({root:"."}).ctor(function(a,b){this.frames=9999;this.viewport=a;this.root=this.options.root.split(/\/+/);e.extend(this.options,b)}).init(function(a,b){a=this;b=this.options;for(var d=this.options.plugins||[],e=[].concat(d),h=0;h<e.length;){var p=e[h].prototype.required;if(p&&p.length)++h;else{p=e.splice(h,1)[0];if(p.prototype.provided){for(var q=p.prototype.provided,m=0;m<e.length;m++)for(var n in q){var h=
e[m].prototype.required,r=(h||[]).indexOf(n);-1!=r&&h.splice(r,1)}h=0}q=p.name;d[m]=new p(this,b[q]);a.wait&&a.wait(d[m])}}if(e.length){for(m=0;m<e.length;m++)q=e[m].name,h=e[m].prototype.required,console.warn(q,"is missing",h);throw Error("Missing or circular dependencies");}a.plugins=d}).ready(function(){var a=this;this.options.start&&window.setTimeout(function(){a.start()},0)}).method("start",function(){var b=this;b.started||b.paused||(a(function(){b.render.call(b)}),b.started=!0)}).method("resize",
